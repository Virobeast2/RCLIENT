...
public class SlowSpawn : ThrottledTask, IProgress
{
    ...
    {
        return new <SpawnAll>c__Iterator3A { SpawnFlags = SpawnFlags, HideFlags = HideFlags, <$>SpawnFlags = SpawnFlags, <$>HideFlags = HideFlags, <>f__this = this, $PC = -2 };
    }

    [DebuggerHidden]
    private IEnumerator Start()
    {
        return new <Start>c__Iterator39 { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <SpawnAll>c__Iterator3A : IDisposable, IEnumerator, IEnumerable, IEnumerable<GameObject>, IEnumerator<GameObject>
    {
        ...
        Label_00A0:
            if (this.<i>__0 < this.<>f__this.Count)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    UnityEngine.Debug.LogException(this.<e>__2);
                    goto Label_0092;
                }
        ...
        IEnumerator<GameObject> IEnumerable<GameObject>.GetEnumerator()
        {
            ...
            return new SlowSpawn.<SpawnAll>c__Iterator3A { <>f__this = this.<>f__this, SpawnFlags = this.<$>SpawnFlags, HideFlags = this.<$>HideFlags };
        }
    ...
    [CompilerGenerated]
    private sealed class <Start>c__Iterator39 : IDisposable, IEnumerator, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            do
            {
                ...
                catch (Exception exception)
                {
                    ...
                    UnityEngine.Debug.LogException(this.<e>__1, this.<>f__this);
                }
