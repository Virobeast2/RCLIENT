...
public class RPOS_Craft_BlueprintList : MonoBehaviour
{
    ...
    public int AddItemsOfCategory(ItemDataBlock.ItemCategory category, System.Collections.Generic.List<BlueprintDataBlock> checkList, int yPos)
    {
    ...
    public bool AnyOfCategoryInList(ItemDataBlock.ItemCategory category, System.Collections.Generic.List<BlueprintDataBlock> checkList)
    {
        foreach (BlueprintDataBlock block in checkList)
        {
            if (block == null)
    ...
    {
        System.Collections.Generic.List<BlueprintDataBlock> boundBPs = RPOS.ObservedPlayer.GetComponent<PlayerInventory>().GetBoundBPs();
        ...
        else if (this.lastNumBoundBPs != count)
        {
            ...
            try
            {
                ...
                {
                    object current = enumerator.Current;
                    UnityEngine.Object.Destroy((current as Transform).gameObject);
                }
            }
            finally
            {
