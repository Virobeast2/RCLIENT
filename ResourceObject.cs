...
public class ResourceObject : IDMain
{
    ...
    public UnityEngine.Mesh[] collisionMeshes;
    private NetEntityID myID;
    public UnityEngine.Mesh[] visualMeshes;
    ...
    public void modelindex(int index, uLink.NetworkMessageInfo info)
    {
        ...
        {
            GameObject obj2 = UnityEngine.Object.Instantiate(this.clientMeshChangeEffect, base.transform.position, base.transform.rotation) as GameObject;
            UnityEngine.Object.Destroy(obj2, 5f);
        }
