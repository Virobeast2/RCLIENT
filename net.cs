...
{
    [ConsoleSystem.Client, Help("connect to a server", "string serverurl")]
    public static void connect(ref ConsoleSystem.Arg arg)
    {
        if (UnityEngine.Object.FindObjectOfType(typeof(ClientConnect)) != null)
        {
    ...
    [Help("disconnect from server", ""), ConsoleSystem.Client]
    ...
    [Help("reconnect to last server", ""), ConsoleSystem.Client]
