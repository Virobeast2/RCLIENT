...
public static class NetErrorHelper
{
    ...
    {
        CacheNiceStrings();
        uLink.NetworkConnectionError noError = uLink.NetworkConnectionError.NoError;
        ...
        try
        {
            while (enumerator.MoveNext())
            {
                ...
                {
                    noError = (uLink.NetworkConnectionError) ((int) current);
                }
            }
        }
        finally
        ...
        if (noError != uLink.NetworkConnectionError.InternalDirectConnectFailed)
        {
