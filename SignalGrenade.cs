...
public class SignalGrenade : RigidObj
{
    ...
    {
        UnityEngine.Object.Destroy(UnityEngine.Object.Instantiate(this.explosionEffect, base.transform.position, Quaternion.LookRotation(Vector3.up)), 60f);
    }
    ...
    {
        this.bounceSound.Play(base.rigidbody.position, (float) 0.25f, UnityEngine.Random.Range((float) 0.85f, (float) 1.15f), 1f, (float) 18f);
    }
