...
public class ServerBrowser : MonoBehaviour
{
    ...
    [NonSerialized]
    public System.Collections.Generic.List<Server>[] servers = new System.Collections.Generic.List<Server>[6];
    [NonSerialized]
    ...
    {
        this.pageNumber = 0;
        foreach (System.Collections.Generic.List<Server> list in this.servers)
        {
            list.Clear();
        }
    ...
    private GameObject NewServerItem()
    {
        ...
        GameObject obj2 = (GameObject) UnityEngine.Object.Instantiate(this.serverItem);
    ...
    {
        return new <ServerListUpdater>c__Iterator33 { <>f__this = this };
    }

    private bool ShouldIgnoreServer(Server item)
    {
        string str = item.name.ToLower();
        ...
        {
            if (((((!char.IsLetterOrDigit(ch) && (ch != '\'')) && ((ch != '[') && (ch != ']'))) && (((ch != '|') && (ch != ' ')) && ((ch != '-') && (ch != '(')))) && ((((ch != '%') && (ch != ')')) && ((ch != '_') && (ch != '@'))) && (((ch != '+') && (ch != '&')) && ((ch != ':') && (ch != '/'))))) && ((((ch != '.') && (ch != '?')) && ((ch != '#') && (ch != '!'))) && (ch != ',')))
            {
                return true;
            }
        }
    ...
    private void Start()
    {
        ...
        {
            this.servers[i] = new System.Collections.Generic.List<Server>();
        }
    ...
    public void UpdateServerList()
    {
        ...
        if (((this.servers[this.serverType].Count != 0) && (index >= 0)) && (index <= this.servers[this.serverType].Count))
        {
            ...
            System.Collections.Generic.List<Server> range = this.servers[this.serverType].GetRange(index, maxServers);
    ...
    [CompilerGenerated]
    private sealed class <ServerListUpdater>c__Iterator33 : IDisposable, IEnumerator, IEnumerator<object>
    {
