...
public class RoadObjectScript : MonoBehaviour
{
    ...
    {
        bool flag = true;
        float y = UnityEngine.Terrain.activeTerrain.transform.position.y;
    ...
    {
        RoadObjectScript[] scriptArray = (RoadObjectScript[]) UnityEngine.Object.FindObjectsOfType(typeof(RoadObjectScript));
    ...
    {
        version = "2.4.6";
        OODCDOQDCC = (GUISkin) UnityEngine.Resources.Load("ER3DSkin", typeof(GUISkin));
        OQOOODODQD = (Texture2D) UnityEngine.Resources.Load("ER3DLogo", typeof(Texture2D));
        ...
        UnityEngine.Terrain[] terrainArray = (UnityEngine.Terrain[]) UnityEngine.Object.FindObjectsOfType(typeof(UnityEngine.Terrain));
        foreach (UnityEngine.Terrain terrain in terrainArray)
        {
            ...
            if (terrain.gameObject.GetComponent<EasyRoads3DTerrainID>() == null)
            {
                ...
                string str = UnityEngine.Random.Range(0x5f5e100, 0x3b9ac9ff).ToString();
                nid.terrainid = str;
                t.id = str;
            }
            else
    ...
    public void ODQDCQQDDO(Vector3 pos, bool doInsert)
    {
        ...
        if ((doInsert && (first >= 0)) && (second >= 0))
        {
            ...
            else
            {
                ...
                Transform transform = (Transform) UnityEngine.Object.Instantiate(oqdqoqdoqo.object1.transform, pos, oqdqoqdoqo.object1.rotation);
    ...
    public void OODDQODDCC(Vector3 pos)
    {
        ...
        {
            obj2 = (GameObject) UnityEngine.Object.Instantiate(this.ODOQDQOO);
        }
        else
        {
            obj2 = (GameObject) UnityEngine.Object.Instantiate(UnityEngine.Resources.Load("marker", typeof(GameObject)));
        }
