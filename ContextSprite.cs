...
[InterfaceDriverComponent(typeof(IContextRequestable), "_contextRequestable", "contextRequestable", AlwaysSaveDisabled=true, SearchRoute=InterfaceSearchRoute.Parents | InterfaceSearchRoute.GameObject, AdditionalProperties="renderer;meshFilter"), RequireComponent(typeof(MeshRenderer)), RequireComponent(typeof(MeshFilter))]
public class ContextSprite : MonoBehaviour
{
    ...
    {
        return new <AllVisibleForRequestable>c__Iterator36 { requestable = requestable, <$>requestable = requestable, $PC = -2 };
    }
    ...
    {
        return new <Retry>c__Iterator35 { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <AllVisibleForRequestable>c__Iterator36 : IDisposable, IEnumerator, IEnumerable, IEnumerable<ContextSprite>, IEnumerator<ContextSprite>
    {
        ...
        IEnumerator<ContextSprite> IEnumerable<ContextSprite>.GetEnumerator()
        {
            ...
            return new ContextSprite.<AllVisibleForRequestable>c__Iterator36 { requestable = this.<$>requestable };
        }
    ...
    [CompilerGenerated]
    private sealed class <Retry>c__Iterator35 : IDisposable, IEnumerator, IEnumerator<object>
    {
