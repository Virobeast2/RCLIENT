...
public static class RustLevel
{
    ...
    private static System.Collections.Generic.List<GameObject> CollectRootGameObjects()
    {
        ...
        foreach (UnityEngine.Object obj2 in UnityEngine.Object.FindObjectsOfType(typeof(Transform)))
        {
            if (obj2 != null)
            {
    ...
    public static Coroutine Load(string levelName, out GameObject loader)
    {
        ...
        System.Type[] components = new System.Type[] { typeof(MonoBehaviour) };
    ...
    {
        return new <LoadRoutine>c__Iterator30 { levelName = levelName, script = script, <$>levelName = levelName, <$>script = script };
    }

    [DebuggerHidden]
    private static IEnumerator WaitForCondition(Func<bool> condition, string requestLabel)
    {
        return new <WaitForCondition>c__Iterator31 { condition = condition, requestLabel = requestLabel, <$>condition = condition, <$>requestLabel = requestLabel };
    }
    ...
    [CompilerGenerated]
    private sealed class <LoadRoutine>c__Iterator30 : IDisposable, IEnumerator, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                ...
                case 3:
                    ...
                    {
                        UnityEngine.Debug.Log("No tree level found.");
                        goto Label_01D3;
                    }
                ...
                case 13:
                    ...
                    {
                        <>f__am$cacheA = new Func<bool>(RustLevel.<LoadRoutine>c__Iterator30.<>m__10);
                    }
                ...
                case 14:
                    ...
                    {
                        <>f__am$cacheB = new Func<bool>(RustLevel.<LoadRoutine>c__Iterator30.<>m__11);
                    }
                ...
                case 15:
                    ...
                    UnityEngine.Object.Destroy(this.script.gameObject);
                    this.$PC = -1;
                    goto Label_0459;
    ...
    [CompilerGenerated]
    private sealed class <WaitForCondition>c__Iterator31 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                ...
                case 1:
                    ...
                    {
                        UnityEngine.Debug.LogWarning(string.Concat(new object[] { "Took ", this.<counter>__0, " additional frame(s) for condition ", this.requestLabel }));
                    }
                    goto Label_010B;
            ...
            {
                UnityEngine.Debug.LogWarning(string.Concat(new object[] { "condition still not met:", this.requestLabel, " ( ", this.<counter>__0, " frames later )" }));
            }
            this.$current = new WaitForEndOfFrame();
            this.$PC = 1;
            return true;
