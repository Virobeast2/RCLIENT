...
public class SurfaceInfoObject : ScriptableObject
{
    ...
    public GameObject GetImpactEffect(ImpactType type)
    {
        ...
        {
            return this.bulletEffects[UnityEngine.Random.Range(0, this.bulletEffects.Length)];
        }
        if (type == ImpactType.Melee)
        {
            return this.meleeEffects[UnityEngine.Random.Range(0, this.meleeEffects.Length)];
        }
        return null;
    }
