...
public sealed class Controllable : IDLocalCharacter
{
    ...
    [NonSerialized]
    private System.Collections.Generic.List<ulong> _rootCountTimeStamps;
    ...
    private void CL_RootControlCountSet(int count, ref uLink.NetworkMessageInfo info)
    {
        if (this._rootCountTimeStamps == null)
        {
            this._rootCountTimeStamps = new System.Collections.Generic.List<ulong>();
        }
    ...
    private bool SetIdle(bool idle)
    {
        ...
        if (idleControl != null)
        {
            ...
            {
                UnityEngine.Debug.LogError(exception, idleControl);
                return true;
            }
        }
        return false;
    ...
    public uLink.NetworkPlayer netPlayer
    {
        get
        {
            return ((this._playerClient == null) ? uLink.NetworkPlayer.unassigned : this._playerClient.netPlayer);
        }
    }
    ...
    private sealed class <>c__Iterator1F : IDisposable, IEnumerator, IEnumerable, IEnumerable<Controllable>, IEnumerator<Controllable>
    {
        ...
        internal int $PC;
        internal System.Collections.Generic.List<PlayerClient>.Enumerator <$s_199>__0;
    ...
    private sealed class <>c__Iterator20 : IDisposable, IEnumerator, IEnumerable, IEnumerable<Controllable>, IEnumerator<Controllable>
    {
        internal Controllable $current;
        internal int $PC;
        internal System.Collections.Generic.List<PlayerClient>.Enumerator <$s_200>__0;
        internal Controllable <controllable>__2;
        internal PlayerClient <pc>__1;
    ...
    private class CL_Binder : IDisposable
    {
        ...
        protected int CountValidate(System.Collections.Generic.List<ulong> ts, int tsCount)
        {
            if (this.Find())
            {
    ...
    {
        public static readonly System.Collections.Generic.List<Controllable> rootLocalPlayerControllables = new System.Collections.Generic.List<Controllable>();
    }
}
