...
[Serializable, AddComponentMenu("Daikon Forge/User Interface/Sprite/Web"), ExecuteInEditMode]
public class dfWebSprite : dfTextureSprite
{
    ...
    {
        return new <downloadTexture>c__Iterator43 { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <downloadTexture>c__Iterator43 : IDisposable, IEnumerator, IEnumerator<object>
    {
            ...
            try
            {
                switch (num)
                {
                    case 1:
                        ...
                        UnityEngine.Debug.Log("Error downloading image: " + this.<request>__0.error);
