...
public class TreeColliderAdd : MonoBehaviour
{
    ...
    private System.Collections.Generic.List<GameObject> treeColliderPool;
    public GameObject treeColliderPrefab;
    private System.Collections.Generic.List<GameObject> usedCollidersPool;
    ...
    private void Start()
    {
        ...
        this.treeColliderPool = new System.Collections.Generic.List<GameObject>();
        this.usedCollidersPool = new System.Collections.Generic.List<GameObject>();
        ...
        {
            GameObject item = UnityEngine.Object.Instantiate(this.treeColliderPrefab, new Vector3(0f, -20000f, 0f), Quaternion.identity) as GameObject;
