...
public abstract class LightStyle : ScriptableObject
{
    ...
    public static implicit operator LightStyle(string name)
    {
        ...
        {
            LightStyle style = (LightStyle) UnityEngine.Resources.Load(name, typeof(LightStyle));
            if (style != null)
            {
        ...
        if (loadedByString.TryGetValue(name, out reference))
        {
            ...
            if (reference.IsAlive && (((UnityEngine.Object) obj2) != null))
            {
                return (LightStyle) obj2;
            }
            LightStyle style2 = (LightStyle) UnityEngine.Resources.Load(name, typeof(LightStyle));
            if (style2 != null)
            {
        ...
        LightStyle target = (LightStyle) UnityEngine.Resources.Load(name, typeof(LightStyle));
        if (target != null)
        {
