...
public class BowWeaponDataBlock : WeaponDataBlock
{
    ...
    public void ArrowReportHit(IDMain hitMain, ArrowMovement arrow, ItemRepresentation itemRepresentation, IBowWeaponItem itemInstance)
    {
        if (hitMain != null)
        {
            ...
            if (component != null)
            {
                ...
                stream.Write<NetEntityID>(NetEntityID.Get((UnityEngine.MonoBehaviour) hitMain), new object[0]);
                stream.Write<Vector3>(hitMain.transform.position, new object[0]);
                itemRepresentation.ActionStream(2, uLink.RPCMode.Server, stream);
    ...
    public void ArrowReportMiss(ArrowMovement arrow, ItemRepresentation itemRepresentation)
    {
        ...
        itemRepresentation.ActionStream(3, uLink.RPCMode.Server, stream);
    }
    ...
    {
        GameObject obj2 = (GameObject) UnityEngine.Object.Instantiate(this.arrowPrefab, pos, ang);
