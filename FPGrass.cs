...
{
    private static System.Collections.Generic.List<FPGrass> AllEnabledFPGrass = new System.Collections.Generic.List<FPGrass>();
    private static System.Collections.Generic.List<FPGrass> AllEnabledFPGrassInstancesSwap = new System.Collections.Generic.List<FPGrass>();
    public float baseLevelSize = 20f;
    public static bool castShadows = false;
    [SerializeField]
    private System.Collections.Generic.List<FPGrassLevel> children = new System.Collections.Generic.List<FPGrassLevel>();
    ...
    private void OnDisable()
    {
        ...
        {
            UnityEngine.Terrain.activeTerrain.detailObjectDistance = 134.6f;
            UnityEngine.Terrain.activeTerrain.detailObjectDensity = 1f;
        }
    }
    ...
    private void OnEnable()
    {
        if (Support.Supported)
        {
            ...
            if (UnityEngine.Terrain.activeTerrain != null)
            {
                UnityEngine.Terrain.activeTerrain.detailObjectDistance = 0f;
                UnityEngine.Terrain.activeTerrain.detailObjectDensity = 0f;
            }
        }
    }
