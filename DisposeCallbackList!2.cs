...
public struct DisposeCallbackList<TOwner, TCallback> : IDisposable where TOwner: UnityEngine.Object where TCallback: class
{
    private readonly Function<TOwner, TCallback> function;
    private TOwner owner;
    private System.Collections.Generic.List<TCallback> list;
    ...
    public bool Add(TCallback value)
    {
        if (this.list == null)
        {
            this.list = new System.Collections.Generic.List<TCallback>();
        }
        else
        {
