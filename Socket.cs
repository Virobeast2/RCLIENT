...
public abstract class Socket
{
    ...
    public TObject Instantiate<TObject>(TObject prefab) where TObject: UnityEngine.Object
    {
    ...
    {
        GameObject obj2 = (GameObject) UnityEngine.Object.Instantiate(prefab, this.position, this.rotation);
    ...
    {
        Transform tr = (Transform) UnityEngine.Object.Instantiate(prefab, this.position, this.rotation);
    ...
    {
        TComponent local = (TComponent) UnityEngine.Object.Instantiate(prefab, this.position, this.rotation);
    ...
    public sealed class Map : Socket.Mapped
    {
        ...
        private static Socket.Map Get<TSource>(TSource source, ref Socket.Map member) where TSource: UnityEngine.Object, Socket.Source
        {
            Socket.Map map2;
        ...
        private Socket.ProxyLink MakeProxy(Socket.CameraSpace socket, int index)
        {
            ...
            System.Type objA = this.source.ProxyScriptType(this.array[index].name);
            if (object.ReferenceEquals(objA, null))
            {
                return null;
            }
            ...
            try
            {
                System.Type[] components = new System.Type[] { objA };
        ...
        public struct Member
        {
            ...
            private bool deleted;
            public Socket.Map Get<T>(T outerInstance) where T: UnityEngine.Object, Socket.Source
            {
                if (this.deleted)
                {
                    return null;
            ...
            public bool Get<T>(T outerInstance, out Socket.Map map) where T: UnityEngine.Object, Socket.Source
            {
                map = this.Get<T>(outerInstance);
                return !object.ReferenceEquals(map, null);
            }

            public bool DeleteBy<T>(T outerInstance) where T: UnityEngine.Object, Socket.Source
            {
                if (this.deleted)
                {
                    return false;
    ...
    public interface Source
    {
        ...
        System.Type ProxyScriptType(string name);
