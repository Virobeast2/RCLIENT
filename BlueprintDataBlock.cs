...
public class BlueprintDataBlock : ToolDataBlock
{
    ...
    private System.Collections.Generic.List<int> lastCanWorkIngredientCount;
    private System.Collections.Generic.List<int> lastCanWorkResult;
    ...
    public virtual bool CanWork(int amount, Inventory workbenchInv)
    {
        ...
        {
            this.lastCanWorkResult = new System.Collections.Generic.List<int>();
        }
        else
        {
        ...
        {
            this.lastCanWorkIngredientCount = new System.Collections.Generic.List<int>(this.ingredients.Length);
        }
        else
        {
