...
public class HostileWildlifeAI : BasicWildLifeAI
{
    ...
    protected override bool PlaySnd(int type)
    {
        ...
        if (type == 5)
        {
            ...
            {
                clip = this.chaseSoundsFar[UnityEngine.Random.Range(0, this.chaseSoundsFar.Length)];
            }
            volume = 1f;
            minDistance = 0.25f;
            maxDistance = 25f;
        ...
        else if (type == 6)
        {
            ...
            {
                clip = this.chaseSoundsClose[UnityEngine.Random.Range(0, this.chaseSoundsClose.Length)];
            }
            volume = 1f;
            minDistance = 0f;
            maxDistance = 10f;
        ...
        else if (type == 2)
        {
            ...
            {
                clip = this.attackSounds[UnityEngine.Random.Range(0, this.attackSounds.Length)];
            }
            volume = 1f;
            minDistance = 0f;
            maxDistance = 10f;
