...
public class RPOS : UnityEngine.MonoBehaviour
{
    ...
    public System.Collections.Generic.List<RPOSWindow> windowList;
    ...
    public void ItemCellClicked(RPOSInventoryCell cell)
    {
        ...
        else if ((item != null) && (item2 != null))
        {
            ...
            NetEntityID fromInvID = NetEntityID.Get((UnityEngine.MonoBehaviour) inventory);
            NetEntityID toInvID = NetEntityID.Get((UnityEngine.MonoBehaviour) inventory2);
            if (shift)
            {
        ...
        {
            NetEntityID yid3 = NetEntityID.Get((UnityEngine.MonoBehaviour) inventory2);
            Inventory.ItemMovePredicted(NetEntityID.Get((UnityEngine.MonoBehaviour) inventory), yid3, slot, num2);
            this._clickedItemCell = null;
            item = null;
            flag = true;
        }
    ...
    private void UseHoverTextThink(Camera sceneCamera)
    {
        ...
        {
            if (!(this.lastUseHoverText is Facepunch.MonoBehaviour))
            {
    ...
    {
        public static System.Collections.Generic.List<RPOSWindow> allWindows = new System.Collections.Generic.List<RPOSWindow>();
