...
public class dfMarkupTokenizer
{
    ...
    private System.Collections.Generic.List<dfMarkupToken> tokens = new System.Collections.Generic.List<dfMarkupToken>();
    private static System.Collections.Generic.List<string> validTags = new System.Collections.Generic.List<string> { "color", "sprite" };
    ...
    public static System.Collections.Generic.List<dfMarkupToken> Tokenize(string source)
    {
        if (singleton == null)
        {
