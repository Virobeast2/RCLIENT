...
public class HUDDirectionalDamage : HUDIndicator
{
    ...
    {
        this.randMin.x = UnityEngine.Random.Range((float) 0f, (float) 0.06f);
        this.randMin.y = UnityEngine.Random.Range((float) 0f, (float) 0.06f);
        this.randMin.z = UnityEngine.Random.Range((float) 0f, (float) 0.06f);
        this.randMin.w = UnityEngine.Random.Range((float) 0f, (float) 0.06f);
        this.randMax.x = UnityEngine.Random.Range((float) 0.94f, (float) 1f);
        this.randMax.y = UnityEngine.Random.Range((float) 0.94f, (float) 1f);
        this.randMax.z = UnityEngine.Random.Range((float) 0.94f, (float) 1f);
        this.randMax.w = UnityEngine.Random.Range((float) 0.94f, (float) 1f);
        int num = UnityEngine.Random.Range(0, 0x40);
        this.swapX = (num & 1) == 1;
