...
public class USpeaker : MonoBehaviour
{
    ...
    private int overlap;
    private System.Collections.Generic.List<float[]> pendingEncode = new System.Collections.Generic.List<float[]>();
    ...
    private System.Collections.Generic.List<USpeakFrameContainer> sendBuffer = new System.Collections.Generic.List<USpeakFrameContainer>();
    ...
    private System.Collections.Generic.List<byte> tempSendBytes = new System.Collections.Generic.List<byte>();
    public bool UseVAD;
    public static System.Collections.Generic.List<USpeaker> USpeakerList = new System.Collections.Generic.List<USpeaker>();
    ...
    private System.Collections.Generic.List<float[]> SplitArray(float[] array, int size)
    {
        float[] numArray;
