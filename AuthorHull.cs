...
public class AuthorHull : AuthorCreation
{
    ...
    protected AuthorHull(System.Type type) : base(type)
    {
                ...
                for (int k = 0; k < length; k++)
                {
                    if (k != num2)
                    {
                        ...
                        if (src != null)
                        {
                            ...
                            {
                                UnityEngine.Debug.LogWarning("no dest for source " + src, src);
                            }
                        }
                        else if (dst != null)
                        {
                            UnityEngine.Debug.LogWarning("no source for dest " + dst, dst);
                        }
                        else
                        {
    ...
    private System.Collections.Generic.List<KeyValuePair<MethodInfo, MonoBehaviour>> CaptureFinalizeMethods(GameObject output, string methodName)
    {
        System.Collections.Generic.List<KeyValuePair<MethodInfo, MonoBehaviour>> list = new System.Collections.Generic.List<KeyValuePair<MethodInfo, MonoBehaviour>>();
    ...
    private void DestroyRepresentations(ref GameObject stored, string suffix)
    {
        ...
        foreach (UnityEngine.Object obj2 in UnityEngine.Object.FindObjectsOfType(typeof(GameObject)))
        {
    ...
    public override IEnumerable<AuthorPeice> DoSceneView()
    {
        if (this.drawBones && (this.modelPrefabInstance != null))
        {
            ...
            if (rootBone != null)
            {
                ...
                System.Collections.Generic.List<Transform> list = rootBone.ListDecendantsByDepth();
    ...
    private void GeneratePrefabInstances()
    {
        ...
        if ((this.generatedHitBox != null) && (this.generatedRigid != null))
        {
            ...
            System.Collections.Generic.List<KeyValuePair<MethodInfo, MonoBehaviour>> list2 = this.CaptureFinalizeMethods(this.generatedHitBox, "OnAuthoredAsHitBoxPrefab");
            System.Collections.Generic.List<KeyValuePair<MethodInfo, MonoBehaviour>> list3 = this.CaptureFinalizeMethods(this.generatedRigid, "OnAuthoredAsRagdollPrefab");
            ...
            foreach (KeyValuePair<MethodInfo, MonoBehaviour> pair in list2)
            {
                if (pair.Value != null)
                {
                    ...
                    {
                        UnityEngine.Debug.LogException(exception, pair.Value);
                    }
                }
            }
            ...
            foreach (KeyValuePair<MethodInfo, MonoBehaviour> pair2 in list3)
            {
                if (pair2.Value != null)
                {
                    ...
                    {
                        UnityEngine.Debug.LogException(exception2, pair2.Value);
                    }
                }
            }
        }
        ...
        if (this.modelPrefabInstance != null)
        {
            ...
            foreach (Transform transform2 in context.GetComponentsInChildren<Transform>(true))
            {
                if (transform2 != null)
                {
                    ...
                    {
                        UnityEngine.Debug.LogWarning("Deleted bone because it was not in the model prefab instance:" + str, context);
    ...
    private GameObject MakeColliderPrefab()
    {
        ...
        Dictionary<Rigidbody, System.Collections.Generic.List<Collider>> dictionary = new Dictionary<Rigidbody, System.Collections.Generic.List<Collider>>();
        foreach (Collider collider in rootBone.GetComponentsInChildren<Collider>())
        {
            ...
            if (attachedRigidbody != null)
            {
                ...
                {
                    list = new System.Collections.Generic.List<Collider>();
        ...
        foreach (KeyValuePair<Rigidbody, System.Collections.Generic.List<Collider>> pair in dictionary)
        {
    ...
    private GameObject MakeHitBoxPrefab()
    {
        ...
        try
        {
            ...
            System.Type[] components = new System.Type[] { typeof(CapsuleCollider), typeof(Rigidbody) };
            ...
            System.Collections.Generic.List<HitShape> list = new System.Collections.Generic.List<HitShape>();
            if (string.IsNullOrEmpty(this.defaultBodyPartLayer))
            {
                nullable = null;
            }
            ...
            foreach (HitBox box in instance.GetComponentsInChildren<HitBox>())
            {
                try
                {
                    ...
                    {
                        UnityEngine.Object.DestroyImmediate(collider2);
                    }
                    if (flag)
                    {
                        UnityEngine.Debug.LogWarning(string.Concat(new object[] { "Overwrite ", box.bodyPart, ". Was ", part, ", now ", box }), box);
                    }
                }
                catch (Exception exception)
                {
                    UnityEngine.Debug.LogError(string.Format("{0}:{2}:{1}", box, exception, box.bodyPart));
                    throw;
                }
            }
    ...
    protected override bool OnGUICreationSettings()
    {
        ...
        {
            UnityEngine.Debug.Log("Thats not a valid selection", context);
            context = null;
        }
        bool flag8 = false;
        ...
        UnityEngine.Object obj4 = AuthorShared.ObjectField("OUTPUT HITBOX", this.hitBoxOutputPrefab, typeof(GameObject), AuthorShared.ObjectFieldFlags.NotInstance | AuthorShared.ObjectFieldFlags.NotModel | AuthorShared.ObjectFieldFlags.Prefab, new GUILayoutOption[0]);
        UnityEngine.Object obj5 = AuthorShared.ObjectField("OUTPUT RAGDOLL", this.ragdollOutputPrefab, typeof(GameObject), AuthorShared.ObjectFieldFlags.NotInstance | AuthorShared.ObjectFieldFlags.NotModel | AuthorShared.ObjectFieldFlags.Prefab, new GUILayoutOption[0]);
        AuthorShared.EndSubSection();
    ...
    private static class HitBoxItems
    {
        ...
        {
            System.Type[] components = new System.Type[] { typeof(TPeice) };
