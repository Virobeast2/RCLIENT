...
public abstract class StructureComponentItem<T> : HeldItem<T> where T: StructureComponentDataBlock
{
    ...
    public virtual void DoPlace()
    {
        ...
        else
        {
            ...
            object[] arguments = new object[] { eyesRay.origin, eyesRay.direction, this._placePos, this._placeRot, (this._master == null) ? uLink.NetworkViewID.unassigned : this._master.networkView.viewID };
            base.itemRepresentation.Action(1, uLink.RPCMode.Server, arguments);
        }
    }
