...
public sealed class LaserGraphics : MonoBehaviour
{
    ...
    [NonSerialized]
    private System.Collections.Generic.List<LaserBeam> beams;
    ...
    [NonSerialized]
    private System.Collections.Generic.List<LaserBeam> willRender;
    ...
    private void RenderLasers(Camera camera)
    {
        if (!this.madeLists)
        {
            this.beams = new System.Collections.Generic.List<LaserBeam>();
            this.willRender = new System.Collections.Generic.List<LaserBeam>();
            this.madeLists = true;
        }
        int cullingMask = camera.cullingMask;
        if (this.beams == null)
        {
            this.beams = new System.Collections.Generic.List<LaserBeam>(LaserBeam.Collect());
        }
        else
        {
            this.beams.Clear();
    ...
    {
        public readonly System.Collections.Generic.List<LaserBeam> beams = new System.Collections.Generic.List<LaserBeam>();
