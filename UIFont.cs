...
[ExecuteInEditMode, AddComponentMenu("NGUI/UI/Font")]
public class UIFont : MonoBehaviour
{
    private static System.Collections.Generic.List<UITextMarkup> _tempMarkup;
    ...
    private System.Collections.Generic.List<Color> mColors = new System.Collections.Generic.List<Color>();
    ...
    public void Print(string text, Color color, NGUI.Meshing.MeshBuffer m, bool encoding, SymbolStyle symbolStyle, Alignment alignment, int lineWidth)
    {
    ...
    public void Print(string text, Color normalColor, NGUI.Meshing.MeshBuffer m, bool encoding, SymbolStyle symbolStyle, Alignment alignment, int lineWidth, ref UITextSelection selection, char carratChar, Color highlightTextColor, Color highlightBarColor, char highlightChar, float highlightSplit)
    {
        if (this.mReplacement != null)
        {
    ...
    public string WrapText(System.Collections.Generic.List<UITextMarkup> markups, string text, float maxWidth, int maxLineCount)
    {
        return this.WrapText(markups, text, maxWidth, maxLineCount, false, SymbolStyle.None);
    }

    public string WrapText(System.Collections.Generic.List<UITextMarkup> markups, string text, float maxWidth, int maxLineCount, bool encoding)
    {
        return this.WrapText(markups, text, maxWidth, maxLineCount, encoding, SymbolStyle.None);
    }

    public string WrapText(System.Collections.Generic.List<UITextMarkup> markups, string text, float maxWidth, int maxLineCount, bool encoding, SymbolStyle symbolStyle)
    {
        if (this.mReplacement != null)
        {
    ...
    public static System.Collections.Generic.List<UITextMarkup> tempMarkup
    {
        get
        {
            if (_tempMarkup == null)
            ...
            return (_tempMarkup = new System.Collections.Generic.List<UITextMarkup>());
        }
    }
