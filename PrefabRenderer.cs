...
public sealed class PrefabRenderer : IDisposable
{
    ...
    private UnityEngine.Mesh[] originalMeshes;
    ...
    public void Refresh()
    {
        ...
        HashSet<UnityEngine.Mesh> set2 = new HashSet<UnityEngine.Mesh>();
        System.Collections.Generic.List<Material[]> list = new System.Collections.Generic.List<Material[]>();
        System.Collections.Generic.List<UnityEngine.Mesh> list2 = new System.Collections.Generic.List<UnityEngine.Mesh>();
        int capacity = 0;
        ...
        for (int i = 0; i < componentsInChildren.Length; i++)
        {
            ...
            if ((((renderer2 != null) && renderer2.enabled) && !renderer2.name.EndsWith("-lod", StringComparison.InvariantCultureIgnoreCase)) && !renderer2.name.EndsWith("_LOD_LOWEST", StringComparison.InvariantCultureIgnoreCase))
            {
                if (renderer2 is MeshRenderer)
                {
                    ...
                    UnityEngine.Mesh sharedMesh = renderer2.GetComponent<MeshFilter>().sharedMesh;
                ...
                else
                {
                    ...
                    componentsInChildren[size++] = renderer2;
                    UnityEngine.Mesh item = ((SkinnedMeshRenderer) renderer2).sharedMesh;
        ...
        Dictionary<UnityEngine.Mesh, int> dictionary2 = new Dictionary<UnityEngine.Mesh, int>(capacity);
        ...
        DoNotCareResize<UnityEngine.Mesh>(ref renderer.originalMeshes, capacity);
        int num9 = 0;
        foreach (UnityEngine.Mesh mesh3 in set2)
        {
    ...
    public void Render(Camera camera, Matrix4x4 world, MaterialPropertyBlock props, Material[] overrideMaterials)
    {
        ...
        foreach (MeshRender render in this.meshes)
        {
            ...
            UnityEngine.Mesh mesh = this.originalMeshes[render.mesh];
            int num2 = 0;
