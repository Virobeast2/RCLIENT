...
public sealed class LockedList<T> : IEnumerable, IList, ICollection, ICollection<T>, IList<T>, IEnumerable<T>, IEquatable<System.Collections.Generic.List<T>>
{
    private readonly System.Collections.Generic.List<T> list;

    private LockedList()
    {
        this.list = new System.Collections.Generic.List<T>(0);
    }

    public LockedList(System.Collections.Generic.List<T> list)
    {
    ...
    public bool Equals(System.Collections.Generic.List<T> list)
    {
    ...
    {
        return (!(obj is LockedList<T>) ? ((obj is System.Collections.Generic.List<T>) && this.list.Equals(obj)) : this.list.Equals(((LockedList<T>) obj).list));
    }
