...
public abstract class HUDIndicator : MonoBehaviour
{
    ...
    private static HUDIndicator InstantiateIndicator(ref Target target, HUDIndicator prefab, PlacementSpace space, Vector3 position, float rotation)
    {
        ...
        HUDIndicator indicator = (HUDIndicator) UnityEngine.Object.Instantiate(prefab, position, quaternion);
    ...
    {
        public static System.Collections.Generic.List<HUDIndicator> activeIndicators = new System.Collections.Generic.List<HUDIndicator>();
    ...
    private struct Target
    {
        ...
        public UIRoot root
        {
            get
            {
                if (this._root == null)
                {
                    System.Type[] components = new System.Type[] { typeof(UIRoot) };
        ...
        public UIAnchor anchor
        {
            get
            {
                if (this._anchor == null)
                {
                    ...
                    System.Type[] components = new System.Type[] { typeof(UIAnchor) };
