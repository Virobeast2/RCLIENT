...
[Serializable, RequireComponent(typeof(BoxCollider)), ExecuteInEditMode]
public abstract class dfControl : MonoBehaviour, IComparable<dfControl>
{
    ...
    public dfGUIManager GetManager()
    {
        ...
        dfGUIManager manager2 = UnityEngine.Object.FindObjectsOfType(typeof(dfGUIManager)).FirstOrDefault<UnityEngine.Object>() as dfGUIManager;
        if (manager2 != null)
        {
    ...
    {
        System.Collections.Generic.List<dfControl> list = (from c in this.GetManager().GetComponentsInChildren<dfControl>()
    ...
    {
        <RaiseEvent>c__AnonStorey50 storey = new <RaiseEvent>c__AnonStorey50 {
            eventName = eventName
        };
        FieldInfo info = base.GetType().GetAllFields().Where<FieldInfo>(new Func<FieldInfo, bool>(storey.<>m__1A)).FirstOrDefault<FieldInfo>();
        if (info != null)
        {
    ...
    internal void RemoveAllEventHandlers()
    {
        ...
        FieldInfo[] infoArray = base.GetType().GetAllFields().Where<FieldInfo>(<>f__am$cache4B).ToArray<FieldInfo>();
    ...
    {
        <RemoveEventHandlers>c__AnonStorey51 storey = new <RemoveEventHandlers>c__AnonStorey51 {
            EventName = EventName
        };
        FieldInfo info = base.GetType().GetAllFields().Where<FieldInfo>(new Func<FieldInfo, bool>(storey.<>m__1B)).FirstOrDefault<FieldInfo>();
        if (info != null)
        {
    ...
    {
        <SetControlIndex>c__AnonStorey52 storey = new <SetControlIndex>c__AnonStorey52 {
            zindex = zindex,
            child = child
        };
    ...
    protected internal bool Signal(GameObject target, string eventName, params object[] args)
    {
        ...
        for (int j = 0; j < components.Length; j++)
        {
            ...
            if (((component != null) && (component.GetType() != null)) && ((!(component is MonoBehaviour) || ((MonoBehaviour) component).enabled) && (component != this)))
            {
                ...
                {
                    MethodInfo info2 = component.GetType().GetMethod(eventName, BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance, null, System.Type.EmptyTypes, null);
                    if (info2 != null)
                    {
    ...
    [CompilerGenerated]
    private sealed class <RaiseEvent>c__AnonStorey50
    {
    ...
    [CompilerGenerated]
    private sealed class <RemoveEventHandlers>c__AnonStorey51
    {
        internal string EventName;
    ...
    [CompilerGenerated]
    private sealed class <SetControlIndex>c__AnonStorey52
    {
