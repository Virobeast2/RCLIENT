...
public abstract class ThrottledTask : MonoBehaviour
{
    [NonSerialized]
    private bool added;
    private static System.Collections.Generic.List<ThrottledTask> AllTasks = new System.Collections.Generic.List<ThrottledTask>();
    ...
    private sealed class <>c__IteratorC : IDisposable, IEnumerator, IEnumerable, IEnumerable<IProgress>, IEnumerator<IProgress>
    {
        ...
        internal int $PC;
        internal System.Collections.Generic.List<ThrottledTask>.Enumerator <$s_118>__0;
