...
[Serializable, ExecuteInEditMode, AddComponentMenu("Daikon Forge/User Interface/Texture Atlas")]
public class dfAtlas : MonoBehaviour
{
    [SerializeField]
    protected System.Collections.Generic.List<ItemInfo> items = new System.Collections.Generic.List<ItemInfo>();
