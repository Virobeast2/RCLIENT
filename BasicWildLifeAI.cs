...
public class BasicWildLifeAI : NetBehaviour, IInterpTimedEventReceiver
{
    ...
    protected virtual bool PlaySnd(int type)
    {
        ...
        if (type == 0)
        {
            ...
            {
                clip = this.idleSounds[UnityEngine.Random.Range(0, this.idleSounds.Length)];
            }
            volume = 0.4f;
            minDistance = 0.25f;
            maxDistance = 8f;
        ...
        else if (type == 3)
        {
            ...
            {
                clip = this.fleeStartSounds[UnityEngine.Random.Range(0, this.fleeStartSounds.Length)];
            }
            volume = 0.9f;
            minDistance = 1.25f;
            maxDistance = 10f;
        ...
        else
        {
            ...
            {
                clip = this.deathSounds[UnityEngine.Random.Range(0, this.deathSounds.Length)];
            }
            volume = 1f;
            minDistance = 2.25f;
            maxDistance = 20f;
