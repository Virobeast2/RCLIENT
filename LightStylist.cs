...
public class LightStylist : MonoBehaviour
{
    ...
    public IEnumerable<float> Weights
    {
        get
        {
            return new <>c__Iterator3E { <>f__this = this, $PC = -2 };
        }
    }

    [CompilerGenerated]
    private sealed class <>c__Iterator3E : IDisposable, IEnumerator, IEnumerable, IEnumerable<float>, IEnumerator<float>
    {
        ...
        IEnumerator<float> IEnumerable<float>.GetEnumerator()
        {
            ...
            return new LightStylist.<>c__Iterator3E { <>f__this = this.<>f__this };
        }
