...
public class NetMainPrefab : ScriptableObject
{
    ...
    [NonSerialized]
    public readonly System.Type MinimumTypeAllowed;
    ...
    protected NetMainPrefab(System.Type minimumType) : this(minimumType, true)
    {
    }

    private NetMainPrefab(System.Type minimumType, bool typeCheck)
    {
    ...
    protected uLink.NetworkView _Creator(string prefabName, NetworkInstantiateArgs args, uLink.NetworkMessageInfo info)
    {
        ...
        Facepunch.NetworkView networkView = instance.networkView;
        if (networkView == null)
        {
            return null;
        }
    ...
    public static T Lookup<T>(string key) where T: UnityEngine.Object
    {
