...
[Serializable, ExecuteInEditMode, RequireComponent(typeof(BoxCollider)), AddComponentMenu("Daikon Forge/User Interface/Sprite/Radial")]
public class dfRadialSprite : dfSprite
{
    ...
    private System.Collections.Generic.List<int> buildTriangles(System.Collections.Generic.List<Vector3> verts)
    {
    ...
    private System.Collections.Generic.List<Vector2> buildUV(System.Collections.Generic.List<Vector3> verts)
    {
        ...
        System.Collections.Generic.List<Vector2> list = new System.Collections.Generic.List<Vector2>(verts.Count);
    ...
    protected override void OnRebuildRenderData()
    {
        if ((base.Atlas != null) && (base.SpriteInfo != null))
        {
            ...
            System.Collections.Generic.List<Vector3> verts = null;
