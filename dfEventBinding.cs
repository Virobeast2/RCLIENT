...
public class dfEventBinding : MonoBehaviour, IDataBindingComponent
{
    ...
    private Delegate createEventProxyDelegate(object target, System.Type delegateType, ParameterInfo[] eventParams, MethodInfo eventHandler)
    {
        <createEventProxyDelegate>c__AnonStorey5B storeyb = new <createEventProxyDelegate>c__AnonStorey5B {
            eventParams = eventParams,
            <>f__this = this
        };
        MethodInfo method = typeof(dfEventBinding).GetMethods(BindingFlags.NonPublic | BindingFlags.Instance).Where<MethodInfo>(new Func<MethodInfo, bool>(storeyb.<>m__2F)).FirstOrDefault<MethodInfo>();
        if (method == null)
        {
            return null;
        }
    ...
    {
        <getField>c__AnonStorey5A storeya = new <getField>c__AnonStorey5A {
            fieldName = fieldName
        };
        return sourceComponent.GetType().GetAllFields().Where<FieldInfo>(new Func<FieldInfo, bool>(storeya.<>m__2E)).FirstOrDefault<FieldInfo>();
    }
    ...
    [CompilerGenerated]
    private sealed class <createEventProxyDelegate>c__AnonStorey5B
    {
    ...
    [CompilerGenerated]
    private sealed class <getField>c__AnonStorey5A
    {
