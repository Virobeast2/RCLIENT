...
[Serializable, RequireComponent(typeof(BoxCollider)), RequireComponent(typeof(dfInputManager)), RequireComponent(typeof(MeshRenderer)), AddComponentMenu("Daikon Forge/User Interface/GUI Manager"), RequireComponent(typeof(MeshFilter)), ExecuteInEditMode]
public class dfGUIManager : MonoBehaviour
{
    ...
    private UnityEngine.Mesh[] renderMesh;
    [SerializeField]
    protected int renderQueueBase = 0xbb8;
    private System.Collections.Generic.List<int> submeshes = new System.Collections.Generic.List<int>();
    ...
    public dfControl AddControl(System.Type type)
    {
        if (!typeof(dfControl).IsAssignableFrom(type))
        {
            throw new InvalidCastException();
        }
        System.Type[] components = new System.Type[] { type };
    ...
    private UnityEngine.Mesh getRenderMesh()
    {
    ...
    private void initialize()
    {
        ...
        else
        {
            ...
            UnityEngine.Mesh[] meshArray1 = new UnityEngine.Mesh[2];
        ...
        if ((!this.overrideCamera && this.consumeMouseEvents) && (Application.isPlaying && (this.occluders != null)))
        {
            ...
            if (Event.current.isMouse && (Input.touchCount > 0))
            {
                ...
                for (int j = 0; j < touchCount; j++)
                {
                    ...
                    {
                        <OnGUI>c__AnonStorey54 storey = new <OnGUI>c__AnonStorey54 {
    ...
    public static void PushModal(dfControl control, ModalPoppedCallback callback = null)
    {
        ...
        ModalControlReference t = new ModalControlReference {
            control = control,
            callback = callback
        };
        modalControlStack.Push(t);
    }

    public static void RefreshAll(bool force = false)
    {
        dfGUIManager[] managerArray = UnityEngine.Object.FindObjectsOfType(typeof(dfGUIManager)) as dfGUIManager[];
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        UnityEngine.Mesh mesh2 = this.getRenderMesh();
                        this.renderFilter.sharedMesh = mesh2;
                        UnityEngine.Mesh mesh = mesh2;
                        mesh.Clear();
    ...
    {
        <SetFocus>c__AnonStorey55 storey = new <SetFocus>c__AnonStorey55();
    ...
    {
        foreach (Camera camera1 in UnityEngine.Object.FindObjectsOfType(typeof(Camera)) as Camera[])
        {
    ...
    [CompilerGenerated]
    private sealed class <OnGUI>c__AnonStorey54
    {
    ...
    [CompilerGenerated]
    private sealed class <SetFocus>c__AnonStorey55
    {
    ...
    private class MaterialCache
    {
        ...
        private class Cache
        {
            ...
            private static System.Collections.Generic.List<dfGUIManager.MaterialCache.Cache> cacheInstances = new System.Collections.Generic.List<dfGUIManager.MaterialCache.Cache>();
            private int currentIndex;
            private System.Collections.Generic.List<Material> instances;

            private Cache()
            {
                this.instances = new System.Collections.Generic.List<Material>(10);
