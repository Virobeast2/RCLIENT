...
{
    private System.Collections.Generic.List<DestroyEntry> mDest = new System.Collections.Generic.List<DestroyEntry>();
    private static UpdateManager mInst;
    private System.Collections.Generic.List<UpdateEntry> mOnCoro = new System.Collections.Generic.List<UpdateEntry>();
    private System.Collections.Generic.List<UpdateEntry> mOnLate = new System.Collections.Generic.List<UpdateEntry>();
    private System.Collections.Generic.List<UpdateEntry> mOnUpdate = new System.Collections.Generic.List<UpdateEntry>();
    private float mTime;

    private void Add(MonoBehaviour mb, int updateOrder, OnUpdate func, System.Collections.Generic.List<UpdateEntry> list)
    {
        int num = 0;
    ...
    {
        return new <CoroutineFunction>c__Iterator48 { <>f__this = this };
    }
    ...
    private void UpdateList(System.Collections.Generic.List<UpdateEntry> list, float delta)
    {
        int count = list.Count;
        while (count > 0)
        {
    ...
    [CompilerGenerated]
    private sealed class <CoroutineFunction>c__Iterator48 : IDisposable, IEnumerator, IEnumerator<object>
    {
