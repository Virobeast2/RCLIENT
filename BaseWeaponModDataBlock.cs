...
public class BaseWeaponModDataBlock : ItemModDataBlock
{
    ...
    protected BaseWeaponModDataBlock(System.Type minimumItemModRepresentationType) : base(minimumItemModRepresentationType)
    {
    ...
    protected override bool InstallToViewModel(ref ModViewModelAddArgs a)
    {
        ...
        if (this.attachObjectVM != null)
        {
            ...
            if (a.isMesh)
            {
                ...
                obj2 = UnityEngine.Object.Instantiate(this.attachObjectVM, socketByName.offset, Quaternion.Euler(socketByName.eulerRotate)) as GameObject;
    ...
    protected override void UninstallFromItemModRepresentation(ItemModRepresentation rep)
    {
        ...
        if (attached != null)
        {
            ...
            UnityEngine.Object.Destroy(attached);
        }
    ...
    protected override void UninstallFromViewModel(ref ModViewModelRemoveArgs a)
    {
        if (this.attachObjectVM != null)
        {
            ...
            if (attached != null)
            {
                ...
                UnityEngine.Object.Destroy(attached.gameObject);
            }
        }
    }
