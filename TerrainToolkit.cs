...
public class TerrainToolkit : MonoBehaviour
{
    ...
    public System.Collections.Generic.List<float> heightBlendPoints;
    ...
    {
        this.heightBlendPoints = new System.Collections.Generic.List<float>();
    }
    ...
    public void erodeAllTerrain(ErosionProgressDelegate erosionProgressDelegate)
    {
        ...
        UnityEngine.Terrain component = (UnityEngine.Terrain) base.GetComponent(typeof(UnityEngine.Terrain));
        if (component != null)
        {
            try
            {
    ...
    private float[,] generateVoronoi(float[,] heightMap, Vector2 arraySize, GeneratorProgressDelegate generatorProgressDelegate)
    {
        ...
        {
            Peak peak = new Peak();
            int num4 = (int) Mathf.Floor(UnityEngine.Random.value * x);
            int num5 = (int) Mathf.Floor(UnityEngine.Random.value * y);
