...
public class Localization : MonoBehaviour
{
        ...
        set
        {
            if (this.mLanguage != value)
            {
                ...
                if (!string.IsNullOrEmpty(value))
                {
                    ...
                    TextAsset asset2 = UnityEngine.Resources.Load(value, typeof(TextAsset)) as TextAsset;
                    if (asset2 != null)
                    {
                        this.Load(asset2);
                        return;
    ...
    public static Localization instance
    {
        get
        {
            if (mInst == null)
            {
                mInst = UnityEngine.Object.FindObjectOfType(typeof(Localization)) as Localization;
                if (mInst == null)
                {
