...
public class GameGizmo : ScriptableObject
{
    ...
    private bool CreateInstance(out Instance instance, System.Type type)
    {
        try
        {
    ...
    public class Instance
    {
        ...
        private System.Collections.Generic.List<UnityEngine.Object> resources = new System.Collections.Generic.List<UnityEngine.Object>();
        ...
        public void AddResourceToDelete(UnityEngine.Object resource)
        {
            if (resource != null)
            {
                ...
                (this.resources = new System.Collections.Generic.List<UnityEngine.Object>()).Add(resource);
            }
        }

        internal void ClearResources()
        {
            System.Collections.Generic.List<UnityEngine.Object> resources = this.resources;
            if (resources != null)
            {
                this.resources = null;
                foreach (UnityEngine.Object obj2 in resources)
                {
        ...
        protected virtual void Render(bool useCamera, Camera camera)
        {
            if (!this.hideMesh)
            {
                UnityEngine.Mesh mesh = this.gameGizmo._mesh;
                if (mesh != null)
                {
                    int num;
