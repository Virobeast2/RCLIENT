...
public class dfTweenGroup : dfTweenPlayableBase
{
    ...
    public System.Collections.Generic.List<dfTweenPlayableBase> Tweens = new System.Collections.Generic.List<dfTweenPlayableBase>();
    ...
    [DebuggerHidden, HideInInspector]
    private IEnumerator runConcurrent()
    {
        return new <runConcurrent>c__Iterator47 { <>f__this = this };
    }

    [HideInInspector, DebuggerHidden]
    private IEnumerator runSequence()
    {
        return new <runSequence>c__Iterator46 { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <runConcurrent>c__Iterator47 : IDisposable, IEnumerator, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                ...
                case 1:
                    ...
                    {
                        <>f__am$cache4 = new Func<dfTweenPlayableBase, bool>(dfTweenGroup.<runConcurrent>c__Iterator47.<>m__35);
                    }
                    if (this.<>f__this.Tweens.Any<dfTweenPlayableBase>(<>f__am$cache4))
                    {
                        break;
                    }
    ...
    [CompilerGenerated]
    private sealed class <runSequence>c__Iterator46 : IDisposable, IEnumerator, IEnumerator<object>
    {
        internal object $current;
        internal int $PC;
        internal dfTweenGroup <>f__this;
