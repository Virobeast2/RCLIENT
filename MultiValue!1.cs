...
public class MultiValue<TValue> : IEnumerable, IEnumerable<TValue>, ICollection<TValue>, IList<TValue>, ICloneable
{
    ...
    private System.Collections.Generic.List<TValue> list;

    public MultiValue()
    {
        this.list = new System.Collections.Generic.List<TValue>();
    ...
    {
        this.hashSet = new HashSet<TValue>(equalityComparer);
        this.list = new System.Collections.Generic.List<TValue>(capacity);
    }
    ...
    {
        this.list = new System.Collections.Generic.List<TValue>(mv.list);
    ...
    {
        return new MultiValue<TValue>(false) { hashSet = new HashSet<TValue>(this.hashSet), list = new System.Collections.Generic.List<TValue>(this.list), count = this.count };
    }
    ...
    private struct InitData
    {
        ...
        public void RecurseInit()
        {
            ...
            this.mv.list = new System.Collections.Generic.List<TValue>(this.mv.count);
        }
    }
    ...
    public struct KeyPair<TKey> : IEnumerable, IEnumerable<TValue>, ICollection<TValue>, IList<TValue>
    {
        ...
        {
            public static readonly System.Collections.Generic.List<TValue> emptyList;

            static g()
            {
                MultiValue<TValue>.KeyPair<TKey>.g.emptyList = new System.Collections.Generic.List<TValue>(0);
            }
        }
    }
}
