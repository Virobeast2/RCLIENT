...
public class dfSpriteAnimation : dfTweenPlayableBase
{
    ...
    {
        return new <Execute>c__Iterator44 { <>f__this = this };
    }
    ...
    {
        System.Collections.Generic.List<string> list = (this.clip == null) ? null : this.clip.Sprites;
    ...
    {
        System.Collections.Generic.List<string> sprites = this.clip.Sprites;
        if (sprites.Count != 0)
        {
    ...
    [CompilerGenerated]
    private sealed class <Execute>c__Iterator44 : IDisposable, IEnumerator, IEnumerator<object>
    {
        ...
        internal System.Collections.Generic.List<string> <sprites>__3;
