...
public sealed class CameraMount : MonoBehaviour
{
    ...
    public static void ClearTemporaryCameraMount()
    {
        ...
        {
            UnityEngine.Object.Destroy(temporaryCameraMount);
            UnityEngine.Object.Destroy(temporaryCameraMountGameObject);
    ...
    private static CameraMount CreateTemporaryCameraMount(CameraMount copyFrom, Transform parent, bool hasParent)
    {
        ...
        try
        {
            ...
            System.Type[] components = new System.Type[] { typeof(CameraMount) };
    ...
    {
        public static readonly System.Collections.Generic.List<CameraMount> list = new System.Collections.Generic.List<CameraMount>();
    }
}
