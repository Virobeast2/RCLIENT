...
[Serializable, AddComponentMenu("Daikon Forge/User Interface/Dropdown List"), RequireComponent(typeof(BoxCollider)), ExecuteInEditMode]
public class dfDropdown : dfInteractiveBase, IDFMultiRender
{
    ...
    private void openPopup()
    {
        if ((this.popup == null) && (this.items.Length != 0))
        {
            ...
            {
                <openPopup>c__AnonStorey53 storey = new <openPopup>c__AnonStorey53();
                storey.activeScrollbar = (UnityEngine.Object.Instantiate(this.listScrollbar.gameObject) as GameObject).GetComponent<dfScrollbar>();
                float num = base.PixelsToUnits();
    ...
    [CompilerGenerated]
    private sealed class <openPopup>c__AnonStorey53
    {
