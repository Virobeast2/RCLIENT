...
public class UITextList : MonoBehaviour
{
    ...
    protected System.Collections.Generic.List<Paragraph> mParagraphs = new System.Collections.Generic.List<Paragraph>();
    ...
    protected void Add(string text, bool updateVisible)
    {
        ...
        {
            item.lines = this.textLabel.font.WrapText(UIFont.tempMarkup, item.text, this.maxWidth / this.textLabel.transform.localScale.y, this.textLabel.maxLineCount, this.textLabel.supportEncoding, this.textLabel.symbolStyle).Split(this.mSeparator);
            this.mTotalLines = 0;
            int num = 0;
    ...
    protected void UpdateVisibleText()
    {
        if ((this.textLabel != null) && (this.textLabel.font != null))
        {
            ...
            while (num4 < count)
            {
                ...
                while (index < length)
                {
                    string str2 = paragraph.lines[index];
                    if (num3 > 0)
                    {
                        num3--;
                    }
