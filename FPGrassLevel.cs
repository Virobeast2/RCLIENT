...
{
    [SerializeField]
    private System.Collections.Generic.List<FPGrassPatch> children = new System.Collections.Generic.List<FPGrassPatch>();
    [SerializeField]
    ...
    public void UpdateLevel(Vector3 position, UnityEngine.Terrain terrain)
    {
