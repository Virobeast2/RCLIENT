namespace RustProto
{
    ...
    public sealed class Vitals : GeneratedMessage<RustProto.Vitals, RustProto.Vitals.Builder>
    {
        ...
        public static Builder CreateBuilder(RustProto.Vitals prototype)
        {
        ...
        public static Recycler<RustProto.Vitals, Builder> Recycler()
        {
            return Recycler<RustProto.Vitals, Builder>.Manufacture();
        }
        ...
        protected override FieldAccessorTable<RustProto.Vitals, Builder> InternalFieldAccessors
        {
            get
            {
        ...
        public sealed class Builder : GeneratedBuilder<RustProto.Vitals, RustProto.Vitals.Builder>
        {
            ...
            public override RustProto.Vitals.Builder MergeFrom(ICodedInputStream input, ExtensionRegistry extensionRegistry)
            {
                ...
                while (input.ReadTag(out num, out str))
                {
                    if ((num == 0) && (str != null))
                    {
                        int index = Array.BinarySearch<string>(RustProto.Vitals._vitalsFieldNames, str, StringComparer.Ordinal);
                        if (index >= 0)
                        {
                            num = RustProto.Vitals._vitalsFieldTags[index];
                        }
                        else
                        {
            ...
            private RustProto.Vitals PrepareBuilder()
            {
                if (this.resultIsReadOnly)
                {
                    RustProto.Vitals result = this.result;
