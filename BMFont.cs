...
public class BMFont
{
    ...
    private int mHeight;
    [HideInInspector, SerializeField]
    private System.Collections.Generic.List<BMGlyph> mSaved = new System.Collections.Generic.List<BMGlyph>();
    [HideInInspector, SerializeField]
    private int mSize;
    [SerializeField, HideInInspector]
    private string mSpriteName;
    [SerializeField, HideInInspector]
    private System.Collections.Generic.List<BMSymbol> mSymbols = new System.Collections.Generic.List<BMSymbol>();
    [SerializeField, HideInInspector]
    private int mWidth;
    ...
    public System.Collections.Generic.List<BMSymbol> symbols
    {
        get
        {
