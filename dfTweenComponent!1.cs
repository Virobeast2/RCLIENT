...
public abstract class dfTweenComponent<T> : dfTweenComponentBase
{
    ...
    {
        return new <Execute>c__Iterator45<T> { property = property, <$>property = property, <>f__this = (dfTweenComponent<T>) this };
    }
    ...
    [CompilerGenerated]
    private sealed class <Execute>c__Iterator45 : IDisposable, IEnumerator, IEnumerator<object>
    {
