...
public class UICamera : MonoBehaviour
{
    ...
    private Camera mCam;
    private static System.Collections.Generic.List<Highlighted> mHighlighted = new System.Collections.Generic.List<Highlighted>();
        ...
        public static class Button
        {
            ...
            public struct RefCollection<T> : IEnumerable, IEnumerable<UICamera.Mouse.Button.Pair<T>>
            {
                ...
                public IEnumerable<UICamera.Mouse.Button.Pair<T>> this[UICamera.Mouse.Button.PressState state]
                {
                    get
                    {
                        return new <>c__Iterator4B<T> { state = state, <$>state = state, <>f__this = *((UICamera.Mouse.Button.RefCollection<T>*) this), $PC = -2 };
                    }
                }
                [DebuggerHidden]
                public unsafe IEnumerator<UICamera.Mouse.Button.Pair<T>> GetEnumerator()
                {
                    return new <GetEnumerator>c__Iterator4C<T> { <>f__this = *((UICamera.Mouse.Button.RefCollection<T>*) this) };
                }
                [CompilerGenerated]
                private sealed class <>c__Iterator4B : IDisposable, IEnumerator, IEnumerable, IEnumerable<UICamera.Mouse.Button.Pair<T>>, IEnumerator<UICamera.Mouse.Button.Pair<T>>
                {
                    ...
                    IEnumerator<UICamera.Mouse.Button.Pair<T>> IEnumerable<UICamera.Mouse.Button.Pair<T>>.GetEnumerator()
                    {
                        ...
                        return new UICamera.Mouse.Button.RefCollection<T>.<>c__Iterator4B { <>f__this = this.<>f__this, state = this.<$>state };
                    }
            ...
            public struct ValCollection<T> : IEnumerable, IEnumerable<UICamera.Mouse.Button.Pair<T>>
            {
                ...
                public IEnumerable<UICamera.Mouse.Button.Pair<T>> this[UICamera.Mouse.Button.PressState state]
                {
                    get
                    {
                        return new <>c__Iterator49<T> { state = state, <$>state = state, <>f__this = *((UICamera.Mouse.Button.ValCollection<T>*) this), $PC = -2 };
                    }
                }
                [DebuggerHidden]
                public unsafe IEnumerator<UICamera.Mouse.Button.Pair<T>> GetEnumerator()
                {
                    return new <GetEnumerator>c__Iterator4A<T> { <>f__this = *((UICamera.Mouse.Button.ValCollection<T>*) this) };
                }
                [CompilerGenerated]
                private sealed class <>c__Iterator49 : IDisposable, IEnumerator, IEnumerable, IEnumerable<UICamera.Mouse.Button.Pair<T>>, IEnumerator<UICamera.Mouse.Button.Pair<T>>
                {
                    internal UICamera.Mouse.Button.Pair<T> $current;
                    internal int $PC;
                    internal UICamera.Mouse.Button.PressState <$>state;
                    ...
                    IEnumerator<UICamera.Mouse.Button.Pair<T>> IEnumerable<UICamera.Mouse.Button.Pair<T>>.GetEnumerator()
                    {
                        ...
                        return new UICamera.Mouse.Button.ValCollection<T>.<>c__Iterator49 { <>f__this = this.<>f__this, state = this.<$>state };
                    }
                ...
                [CompilerGenerated]
                private sealed class <GetEnumerator>c__Iterator4A : IDisposable, IEnumerator, IEnumerator<UICamera.Mouse.Button.Pair<T>>
                {
                    internal UICamera.Mouse.Button.Pair<T> $current;
                    internal int $PC;
                    internal UICamera.Mouse.Button.ValCollection<T> <>f__this;
