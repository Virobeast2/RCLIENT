...
public sealed class Loadout : ScriptableObject
{
    ...
    {
        return new <EnumerateAdditions>c__Iterator3C { arrays = arrays, <$>arrays = arrays, $PC = -2 };
    }

    [DebuggerHidden]
    private static IEnumerable<Entry> EnumerateRequired(Entry[][] arrays)
    {
        return new <EnumerateRequired>c__Iterator3D { arrays = arrays, <$>arrays = arrays, $PC = -2 };
    }
    ...
    private void GetAdditionArray(ref Inventory.Addition[] array, bool forceUpdate)
    {
        ...
        {
            array = new System.Collections.Generic.List<Inventory.Addition>(EnumerateAdditions(this.GetEntryArrays())).ToArray();
        }
    }
    ...
    private void GetMinimumRequirementArray(ref Entry[] array, bool forceUpdate)
    {
        if (forceUpdate || (array == null))
        {
            array = new System.Collections.Generic.List<Entry>(EnumerateRequired(this.GetEntryArrays())).ToArray();
        }
    }
    ...
    [CompilerGenerated]
    private sealed class <EnumerateAdditions>c__Iterator3C : IDisposable, IEnumerator, IEnumerable, IEnumerable<Inventory.Addition>, IEnumerator<Inventory.Addition>
    {
        ...
        IEnumerator<Inventory.Addition> IEnumerable<Inventory.Addition>.GetEnumerator()
        {
            ...
            return new Loadout.<EnumerateAdditions>c__Iterator3C { arrays = this.<$>arrays };
        }
    ...
    [CompilerGenerated]
    private sealed class <EnumerateRequired>c__Iterator3D : IDisposable, IEnumerator, IEnumerable, IEnumerable<Loadout.Entry>, IEnumerator<Loadout.Entry>
    {
        ...
        IEnumerator<Loadout.Entry> IEnumerable<Loadout.Entry>.GetEnumerator()
        {
            ...
            return new Loadout.<EnumerateRequired>c__Iterator3D { arrays = this.<$>arrays };
        }
