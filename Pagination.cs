...
public class Pagination : MonoBehaviour
{
    ...
    public void DropSpacer(ref Vector3 vPos)
    {
        if (this.spacerLabel != null)
        {
            ...
            dfControl child = ((GameObject) UnityEngine.Object.Instantiate(this.spacerLabel)).GetComponent<dfControl>();
        ...
        if ((this.pageCount != iPages) || (this.pageCurrent != iCurrentPage))
        {
            ...
            if (this.pageCount > 1)
            {
                ...
                for (int i = 0; i < this.pageCount; i++)
                {
                    ...
                    {
                        dfButton child = ((GameObject) UnityEngine.Object.Instantiate(this.clickableButton)).GetComponent<dfButton>();
                        component.AddControl(child);
