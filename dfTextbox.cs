...
[Serializable, ExecuteInEditMode, RequireComponent(typeof(BoxCollider)), AddComponentMenu("Daikon Forge/User Interface/Textbox")]
public class dfTextbox : dfInteractiveBase, IDFMultiRender
{
    ...
    {
        return new <doCursorBlink>c__Iterator42 { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <doCursorBlink>c__Iterator42 : IDisposable, IEnumerator, IEnumerator<object>
    {
