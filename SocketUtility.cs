...
public static class SocketUtility
{
    ...
    {
        return ((!object.ReferenceEquals(mapped, null) && (mapped is UnityEngine.Object)) ? mapped.socketMap : null);
    }

    public static bool GetSocketMapOrNull(this Socket.Mapped mapped, out Socket.Map map)
    {
        if (object.ReferenceEquals(mapped, null) || !(mapped is UnityEngine.Object))
        {
            map = null;
            return false;
        }
