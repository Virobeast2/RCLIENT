...
public abstract class AuthorShared : MonoBehaviour
{
    ...
    public static TComponent AddComponent<TComponent>(GameObject target, string type) where TComponent: Component
    {
        ...
        if (component != null)
        {
            ...
            UnityEngine.Debug.LogWarning("The string type \"" + type + "\" is a component class but does not inherit \"" + typeof(TComponent).AssemblyQualifiedName + "\"", target);
            UnityEngine.Object.DestroyImmediate(component);
            return null;
        }
        UnityEngine.Debug.LogWarning("The string type \"" + type + "\" evaluated to no component type. null returning", target);
        return null;
    }
    ...
    private static bool AuthorPopupGenerate(object arg, ref int selected, out GUIContent[] options, out Array array)
    {
        ...
        System.Collections.Generic.List<AuthorPeice> list = new System.Collections.Generic.List<AuthorPeice>(generate.creation.EnumeratePeices(generate.selectedOnly));
    ...
    public static ObjectKind GetObjectKind(UnityEngine.Object value)
    {
    ...
    public static Content ObjectContent<T>() where T: UnityEngine.Object
    {
        return ObjectContentR(null, typeof(T));
    }

    public static Content ObjectContent(System.Type type)
    {
        return ObjectContentR(null, type);
    }

    public static Content ObjectContent<T>(T o) where T: UnityEngine.Object
    {
        return ObjectContentR(o, typeof(T));
    }

    public static Content ObjectContent(UnityEngine.Object o, System.Type type)
    {
        return ObjectContentR(o, type);
    }

    public static Content ObjectContent<T>(T o, System.Type type) where T: UnityEngine.Object
    {
        System.Type expressionStack_18_0;
        ...
        else
        {
            ...
            System.Type expressionStack_D_0 = type;
        }
        expressionStack_18_1 = expressionStack_D_1;
        expressionStack_18_0 = typeof(T);
    Label_0018:
        return ObjectContentR((UnityEngine.Object) expressionStack_18_1, expressionStack_18_0);
    }

    private static Content ObjectContentR(UnityEngine.Object o, System.Type type)
    {
        return GUIContent.none;
    }

    public static UnityEngine.Object ObjectField(UnityEngine.Object obj, System.Type type, params GUILayoutOption[] options)
    {
        return ObjectField(new Content(), obj, type, false, options);
    }

    public static bool ObjectField<T>(Content content, ref T reference, ObjectFieldFlags flags, params GUILayoutOption[] options) where T: UnityEngine.Object
    {
        return ObjectField<T>(content, ref reference, typeof(T), flags, options);
    }

    public static UnityEngine.Object ObjectField(UnityEngine.Object obj, System.Type type, ObjectFieldFlags flags, params GUILayoutOption[] options)
    {
        return ObjectField(new Content(), obj, type, flags, options);
    }

    public static bool ObjectField<T>(Content content, ref T reference, System.Type type, ObjectFieldFlags flags, params GUILayoutOption[] options) where T: UnityEngine.Object
    {
        UnityEngine.Object obj2;
        System.Type expressionStack_1E_0;
        ...
        else
        {
            ...
            System.Type expressionStack_13_0 = type;
        }
        expressionStack_1E_2 = expressionStack_13_2;
        expressionStack_1E_1 = expressionStack_13_1;
        expressionStack_1E_0 = typeof(T);
    Label_001E:
        obj2 = ObjectField(expressionStack_1E_2, (UnityEngine.Object) expressionStack_1E_1, expressionStack_1E_0, flags, options);
        if (GUI.changed)
        {
            reference = (T) obj2;
            return true;
    ...
    public static UnityEngine.Object ObjectField(Content label, UnityEngine.Object value, System.Type type, ObjectFieldFlags flags, params GUILayoutOption[] options)
    {
        return ObjectField(label, value, type, (flags & ObjectFieldFlags.AllowScene) == ObjectFieldFlags.AllowScene, options);
    }

    public static UnityEngine.Object ObjectField(Content label, UnityEngine.Object value, System.Type type, bool allowScene, params GUILayoutOption[] options)
    {
        return value;
    }
    ...
    public static bool PeiceField<T>(Content content, AuthorCreation self, ref T peice, System.Type type, GUIStyle style, params GUILayoutOption[] options) where T: AuthorPeice
    {
        return PeiceFieldBase<T>(content, self, ref peice, type, true, style, options);
    }

    public static bool PeiceField<T>(Content content, AuthorPeice self, ref T peice, System.Type type, GUIStyle style, params GUILayoutOption[] options) where T: AuthorPeice
    {
        return PeiceFieldBase<T>(content, self, ref peice, type, false, style, options);
    }

    public static bool PeiceField<T>(Content content, AuthorPeice self, ref T peice, System.Type type, bool allowSelf, GUIStyle style, params GUILayoutOption[] options) where T: AuthorPeice
    {
        return PeiceFieldBase<T>(content, self, ref peice, type, allowSelf, style, options);
    }

    private static bool PeiceFieldBase<T>(Content content, AuthorShared self, ref T peice, System.Type type, bool allowSelf, GUIStyle style, params GUILayoutOption[] options) where T: AuthorPeice
    {
        return false;
    }
    ...
    protected class AttributeKeyValueList
    {
        ...
        [DebuggerHidden]
        private static IEnumerable<Component> GetComponentDown(GameObject go, System.Type type)
        {
            return new <GetComponentDown>c__Iterator1 { go = go, type = type, <$>go = go, <$>type = type, $PC = -2 };
        }

        [DebuggerHidden]
        private static IEnumerable<Component> GetComponentDown(GameObject go, System.Type type, Transform childSkip)
        {
            return new <GetComponentDown>c__Iterator0 { go = go, type = type, childSkip = childSkip, <$>go = go, <$>type = type, <$>childSkip = childSkip, $PC = -2 };
        }

        [DebuggerHidden]
        private static IEnumerable<Component> GetComponentUp(GameObject go, System.Type type, bool andThenDown)
        {
        ...
        private static void RunInstance(MonoBehaviour instance, AuthField attribute, ArrayList args)
        {
            ...
            if (!(!(obj2 is UnityEngine.Object) ? (obj2 != null) : ((bool) ((UnityEngine.Object) obj2))))
            {
                System.Type fieldType = attribute.field.FieldType;
        ...
        private static bool SearchGameObject(GameObject self, AuthField attribute, ArrayList options, bool isComponent, ref object value)
        {
            ...
            try
            {
                while (enumerator.MoveNext())
                {
                    ...
                    {
                        UnityEngine.Object obj3 = (UnityEngine.Object) current;
        ...
        {
            System.Type type = !isComponent ? typeof(Transform) : attribute.field.FieldType;
            IEnumerator enumerator = options.GetEnumerator();
            try
            {
                while (enumerator.MoveNext())
        ...
        {
            private static readonly Dictionary<System.Type, AuthorShared.AttributeKeyValueList.TypeRunnerPlatform> platforms = new Dictionary<System.Type, AuthorShared.AttributeKeyValueList.TypeRunnerPlatform>();

            public static void Exec(MonoBehaviour monoBehaviour, AuthorShared.AttributeKeyValueList kv)
            {
                if (monoBehaviour != null)
                {
                    System.Type key = monoBehaviour.GetType();
            ...
            private static void GeneratePlatform(System.Type type, out AuthorShared.AttributeKeyValueList.TypeRunnerPlatform platform)
            {
        ...
        private static class TypeRunner<T> where T: MonoBehaviour
        {
            ...
            static TypeRunner()
            {
                ...
                for (int i = 0; i < length; i++)
                {
                    ...
                    System.Collections.Generic.List<KeyValuePair<AuthTarg, AuthorShared.AttributeKeyValueList.AuthField>> list = new System.Collections.Generic.List<KeyValuePair<AuthTarg, AuthorShared.AttributeKeyValueList.AuthField>>();
                    do
                    {
                        flag = false;
                        int index = 0;
