...
public sealed class DeathTransfer : IDLocalCharacterAddon, IInterpTimedEventReceiver
{
    ...
    {
        uLink.NetworkView view = uLink.NetworkView.Find(attackerViewID);
        if (view == null)
        {
            this.Client_OnKilledShared(false, null, ref info);
        }
    ...
    private void Client_OnKilledShared(bool killedBy, Character attacker, ref uLink.NetworkMessageInfo info)
    {
        ...
        death[UnityEngine.Random.Range(0, death.Length)].Play(base.transform.position, (float) 1f, (float) 1f, (float) 10f);
    ...
    private Ragdoll CreateRagdoll()
    {
        ...
        GameObject obj2 = UnityEngine.Object.Instantiate(trait.ragdollPrefab, base.transform.position, base.transform.rotation) as GameObject;
        Ragdoll component = obj2.GetComponent<Ragdoll>();
        component.sourceMain = base.idMain;
        this._ragdollInstance = obj2;
        UnityEngine.Object.Destroy(obj2, 80f);
