namespace Facepunch
{
    ...
    public static class Bundling
    {
        ...
        public static bool Load<T>(string path, out T asset) where T: UnityEngine.Object
        {
        ...
        public static T Load<T>(string path, System.Type type) where T: UnityEngine.Object
        {
            T local;
        ...
        public static bool Load(string path, System.Type type, out UnityEngine.Object asset)
        {
        ...
        public static bool Load<T>(string path, System.Type type, out T asset) where T: UnityEngine.Object
        {
            UnityEngine.Object obj2;
        ...
        public static UnityEngine.Object[] LoadAll()
        {
            ...
            return new List<UnityEngine.Object>(Map.Assets.LoadAll()).ToArray();
        }
        ...
        public static T[] LoadAll<T>() where T: UnityEngine.Object
        {
            ...
            IEnumerator<UnityEngine.Object> enumerator = Map.Assets.LoadAll(typeof(T)).GetEnumerator();
            try
            {
        ...
        public static UnityEngine.Object[] LoadAll(System.Type type)
        {
            ...
            return new List<UnityEngine.Object>(Map.Assets.LoadAll(type)).ToArray();
        }

        public static T[] LoadAll<T>(System.Type type) where T: UnityEngine.Object
        {
            if (!typeof(T).IsAssignableFrom(type))
            {
                throw new ArgumentException(string.Format("The given type ({1}) cannot cast to {0}", typeof(T), type), "type");
            ...
            List<T> list = new List<T>();
            IEnumerator<UnityEngine.Object> enumerator = Map.Assets.LoadAll(type).GetEnumerator();
            try
            {
                while (enumerator.MoveNext())
                {
        ...
        [Obsolete("This only works outside of editor for now, avoid it")]
        public static AssetBundleRequest LoadAsync(string path, System.Type type)
        {
        ...
        [Obsolete("This only works outside of editor for now, avoid it")]
        public static bool LoadAsync(string path, System.Type type, out AssetBundleRequest request)
        {
            if (!HasLoadedBundleMap)
            {
                throw new InvalidOperationException("Bundles were not loaded");
        ...
        {
            private readonly Dictionary<System.Type, List<Bundling.LoadedBundle>> assetsMap = new Dictionary<System.Type, List<Bundling.LoadedBundle>>();
            private System.Type lastAssetMapSearchKey;
            ...
            private List<Bundling.LoadedBundle> AssetListOfType(System.Type type)
            {
            ...
            private bool Remove(System.Type type)
            {
        ...
        private class LoadedBundle
        {
            ...
            public AssetBundleRequest LoadAsync(string path, System.Type type)
            {
        ...
        {
            [CompilerGenerated]
            private static Comparison<KeyValuePair<System.Type, List<Bundling.LoadedBundle>>> <>f__am$cache3;
            public readonly Bundling.LoadedBundleListOfAssets[] AllLoadedBundleAssetLists;
            private readonly short[] tempBuffer;
            private readonly Dictionary<System.Type, short[]> typeMap = new Dictionary<System.Type, short[]>();

            internal LoadedBundleAssetMap(IEnumerable<KeyValuePair<System.Type, List<Bundling.LoadedBundle>>> assets)
            {
                List<KeyValuePair<System.Type, List<Bundling.LoadedBundle>>> list = new List<KeyValuePair<System.Type, List<Bundling.LoadedBundle>>>(assets);
                if (<>f__am$cache3 == null)
                {
                    <>f__am$cache3 = new Comparison<KeyValuePair<System.Type, List<Bundling.LoadedBundle>>>(Bundling.LoadedBundleAssetMap.<LoadedBundleAssetMap>m__2);
                }
                ...
                {
                    KeyValuePair<System.Type, List<Bundling.LoadedBundle>> pair = list[i];
            ...
            [CompilerGenerated]
            private static int <LoadedBundleAssetMap>m__2(KeyValuePair<System.Type, List<Bundling.LoadedBundle>> x, KeyValuePair<System.Type, List<Bundling.LoadedBundle>> y)
            {
            ...
            public bool Load(string path, System.Type type, out UnityEngine.Object asset)
            {
                short[] numArray;
                if (!this.TypeIndices(type, out numArray))
                {
                    UnityEngine.Debug.Log("no type index for " + type);
                    asset = null;
                    return false;
                }
                int index = 0;
            ...
            [DebuggerHidden]
            public IEnumerable<UnityEngine.Object> LoadAll(System.Type type)
            {
                return new <LoadAll>c__Iterator16 { type = type, <$>type = type, <>f__this = this, $PC = -2 };
            }

            public bool LoadAsync(string path, System.Type type, out AssetBundleRequest request)
            {
                short[] numArray;
                if (!this.TypeIndices(type, out numArray))
                {
            ...
            private bool TypeIndices(System.Type key, out short[] value)
            {
                if (key == null)
                {
            ...
            [CompilerGenerated]
            private sealed class <LoadAll>c__Iterator15 : IDisposable, IEnumerator, IEnumerable, IEnumerable<UnityEngine.Object>, IEnumerator<UnityEngine.Object>
            {
                internal UnityEngine.Object $current;
                internal int $PC;
                ...
                internal UnityEngine.Object[] <$s_160>__6;
                internal int <$s_161>__7;
                internal Bundling.LoadedBundleAssetMap <>f__this;
                internal UnityEngine.Object <asset>__8;
                ...
                UnityEngine.Object IEnumerator<UnityEngine.Object>.Current
                {
                    [DebuggerHidden]
                    get
                    {
            ...
            [CompilerGenerated]
            private sealed class <LoadAll>c__Iterator16 : IDisposable, IEnumerator, IEnumerable, IEnumerable<UnityEngine.Object>, IEnumerator<UnityEngine.Object>
            {
                internal UnityEngine.Object $current;
                internal int $PC;
                ...
                internal UnityEngine.Object[] <$s_164>__5;
                internal int <$s_165>__6;
                internal Bundling.LoadedBundle[] <$s_166>__9;
                internal int <$s_167>__10;
                internal UnityEngine.Object[] <$s_168>__12;
                internal int <$s_169>__13;
                internal Bundling.LoadedBundleAssetMap <>f__this;
                internal UnityEngine.Object <asset>__14;
                internal UnityEngine.Object <asset>__7;
        ...
        private class LoadedBundleListOfAssets
        {
            ...
            public readonly System.Type TypeOfAssets;

            public LoadedBundleListOfAssets(System.Type typeOfAssets, List<Bundling.LoadedBundle> bundles)
            {
            ...
            [CompilerGenerated]
            private sealed class <LoadAll>c__Iterator17 : IDisposable, IEnumerator, IEnumerable, IEnumerable<UnityEngine.Object>, IEnumerator<UnityEngine.Object>
            {
                internal UnityEngine.Object $current;
                internal int $PC;
                internal Bundling.LoadedBundle[] <$s_170>__0;
                internal int <$s_171>__1;
                internal UnityEngine.Object[] <$s_172>__3;
                internal int <$s_173>__4;
                internal Bundling.LoadedBundleListOfAssets <>f__this;
                internal UnityEngine.Object <asset>__5;
            ...
            [CompilerGenerated]
            private sealed class <LoadAll>c__Iterator18 : IDisposable, IEnumerator, IEnumerable, IEnumerable<UnityEngine.Object>, IEnumerator<UnityEngine.Object>
            {
                internal UnityEngine.Object $current;
                internal int $PC;
                internal System.Type <$>type;
                ...
                internal UnityEngine.Object[] <$s_176>__3;
        ...
        private class LoadedBundleMap : IDisposable
        {
            ...
            public LoadedBundleMap(IEnumerable<KeyValuePair<System.Type, List<Bundling.LoadedBundle>>> assets, IEnumerable<Bundling.LoadedBundle> scenes)
            {
