namespace Facepunch.Load
{
    ...
    public sealed class Loader : IDisposable, IDownloadTask
    {
        ...
        public static Facepunch.Load.Loader Create(Reader reader, IDownloaderDispatch dispatch)
        {
            return Deserialize(reader, dispatch);
        }

        public static Facepunch.Load.Loader CreateFromFile(string downloadListPath, IDownloaderDispatch dispatch)
        {
        ...
        public static Facepunch.Load.Loader CreateFromFile(string downloadListPath, string bundlePath, IDownloaderDispatch dispatch)
        {
        ...
        public static Facepunch.Load.Loader CreateFromReader(JsonReader jsonReader, string bundlePath, IDownloaderDispatch dispatch)
        {
        ...
        public static Facepunch.Load.Loader CreateFromReader(TextReader textReader, string bundlePath, IDownloaderDispatch dispatch)
        {
        ...
        public static Facepunch.Load.Loader CreateFromText(string downloadListJson, string bundlePath, IDownloaderDispatch dispatch)
        {
        ...
        private static Facepunch.Load.Loader Deserialize(Reader reader, IDownloaderDispatch dispatch)
        {
            ...
            while (reader.Read())
            {
                switch (reader.Token)
                {
                    ...
                    case Token.DownloadQueueEnd:
                    {
                        ...
                        return (operation.Loader = new Facepunch.Load.Loader(masterGroup, allJobs, allGroups, dispatch));
                    }
                }
            }
        ...
        private sealed class <>c__Iterator25 : IDisposable, IEnumerator, IEnumerator<object>
        {
            ...
            internal int $PC;
            internal Facepunch.Load.Loader <>f__this;
