...
public class ContextTest : Facepunch.MonoBehaviour, IContextRequestable, IContextRequestableMenu, IComponentInterface<IContextRequestable, Facepunch.MonoBehaviour, Contextual>, IComponentInterface<IContextRequestable, Facepunch.MonoBehaviour>, IComponentInterface<IContextRequestable>
{
    ...
    {
        return new <ContextQueryMenu>c__Iterator37 { <>f__this = this, $PC = -2 };
    }
    ...
    [CompilerGenerated]
    private sealed class <ContextQueryMenu>c__Iterator37 : IDisposable, IEnumerator, IEnumerable, IEnumerable<ContextActionPrototype>, IEnumerator<ContextActionPrototype>
    {
        ...
        IEnumerator<ContextActionPrototype> IEnumerable<ContextActionPrototype>.GetEnumerator()
        {
            ...
            return new ContextTest.<ContextQueryMenu>c__Iterator37 { <>f__this = this.<>f__this };
        }
