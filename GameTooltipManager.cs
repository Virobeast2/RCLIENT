...
public class GameTooltipManager : MonoBehaviour
{
    ...
    protected System.Collections.Generic.List<TooltipContainer> tooltips = new System.Collections.Generic.List<TooltipContainer>();
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < 0x10; i++)
        {
            ...
            GameObject obj2 = (GameObject) UnityEngine.Object.Instantiate(this.tooltipPrefab);
