...
public class AuthorChHit : AuthorPeice
{
    ...
    {
        AuthorChJoint joint = base.creation.CreatePeice<AuthorChJoint>(kind.ToString(), new System.Type[0]);
        if (joint != null)
        {
    ...
    public void CreateHitBoxOn(System.Collections.Generic.List<HitShape> list, Transform instance, Transform root)
    {
        this.CreateHitBoxOn(list, instance, root, null);
    }

    public void CreateHitBoxOn(System.Collections.Generic.List<HitShape> list, Transform instance, Transform root, int? layerIndex)
    {
        if (this.bone != null)
        {
