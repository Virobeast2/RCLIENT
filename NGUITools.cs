...
public static class NGUITools
{
    ...
    public static int ParseSymbol(string text, int index, System.Collections.Generic.List<Color> colors, ref int symbolSkipCount)
    {
    ...
    public static string UnformattedString(string str)
    {
        ...
        if (index != -1)
        {
            if (startIndex != -1)
            {
                ...
                System.Collections.Generic.List<bool> list2 = new System.Collections.Generic.List<bool> {
                    index,
                    startIndex,
                    true,
                    false
