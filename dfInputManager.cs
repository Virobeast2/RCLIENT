...
public class dfInputManager : MonoBehaviour
{
    ...
    public void OnEnable()
    {
        ...
        if (this.adapter == null)
        {
            ...
            Component component = base.GetComponents(typeof(MonoBehaviour)).Where<Component>(<>f__am$cacheF).FirstOrDefault<Component>();
    ...
    private class TouchInputManager
    {
        ...
        private System.Collections.Generic.List<ControlTouchTracker> tracked;
        private System.Collections.Generic.List<int> untracked;

        private TouchInputManager()
        {
            this.tracked = new System.Collections.Generic.List<ControlTouchTracker>();
            this.untracked = new System.Collections.Generic.List<int>();
        }
        ...
        internal void Process(Transform transform, Camera renderCamera, dfList<Touch> touches, bool retainFocus)
        {
            ...
            {
                <Process>c__AnonStorey56 storey = new <Process>c__AnonStorey56();
                ...
                ControlTouchTracker tracker = this.tracked.FirstOrDefault<ControlTouchTracker>(new Func<ControlTouchTracker, bool>(storey.<>m__26));
                if (tracker != null)
                {
                ...
                if (!flag && (dfInputManager.controlUnderMouse != null))
                {
                    ...
                    if (!this.tracked.Any<ControlTouchTracker>(<>f__am$cache3))
                    {
        ...
        [CompilerGenerated]
        private sealed class <Process>c__AnonStorey56
        {
        ...
        private class ControlTouchTracker
        {
            ...
            public System.Collections.Generic.List<int> capture = new System.Collections.Generic.List<int>();
            ...
            private System.Collections.Generic.List<Touch> getActiveTouches()
            {
                <getActiveTouches>c__AnonStorey57 storey = new <getActiveTouches>c__AnonStorey57();
                Touch[] touches = Input.touches;
                if (<>f__am$cache6 == null)
                {
                    <>f__am$cache6 = x => x.Value.touch;
                }
                storey.result = this.touches.Select<KeyValuePair<int, dfInputManager.TouchInputManager.TouchRaycast>, Touch>(<>f__am$cache6).ToList<Touch>();
                <getActiveTouches>c__AnonStorey58 storey2 = new <getActiveTouches>c__AnonStorey58 {
                    <>f__ref$87 = storey,
                    i = 0
                };
                while (storey2.i < storey.result.Count)
                {
                    storey.result[storey2.i] = touches.First<Touch>(new Func<Touch, bool>(storey2.<>m__29));
                    storey2.i++;
                }
            ...
            public bool Process(dfInputManager.TouchInputManager.TouchRaycast info)
            {
                ...
                if (!this.touches.ContainsKey(info.FingerID))
                {
                    ...
                    if (info.Phase == TouchPhase.Began)
                    {
                        ...
                        System.Collections.Generic.List<Touch> touches = this.getActiveTouches();
                ...
                if (this.touches.Count > 1)
                {
                    System.Collections.Generic.List<Touch> list2 = this.getActiveTouches();
            ...
            [CompilerGenerated]
            private sealed class <getActiveTouches>c__AnonStorey57
            {
                internal System.Collections.Generic.List<Touch> result;
            }

            [CompilerGenerated]
            private sealed class <getActiveTouches>c__AnonStorey58
            {
                internal dfInputManager.TouchInputManager.ControlTouchTracker.<getActiveTouches>c__AnonStorey57 <>f__ref$87;
                internal int i;

                internal bool <>m__29(Touch x)
                {
                    Touch touch = this.<>f__ref$87.result[this.i];
