...
public class UIPopupList : MonoBehaviour
{
    ...
    private System.Collections.Generic.List<UILabel> mLabelList = new System.Collections.Generic.List<UILabel>();
    ...
    private void Highlight(UILabel lbl, bool instant)
    {
        if (this.mHighlight != null)
        {
            ...
            if ((component == null) || !component.enabled)
            {
                ...
                float y = sprite.inner.yMin - sprite.outer.yMin;
                Vector3 pos = lbl.cachedTransform.localPosition + new Vector3(-num, y, 0f);
