...
public class dfDynamicFont : dfFontBase
{
    ...
    private static System.Collections.Generic.List<dfDynamicFont> loadedFonts = new System.Collections.Generic.List<dfDynamicFont>();
    [SerializeField]
    ...
    private void OnFontChanged()
    {
        try
        {
            <OnFontChanged>c__AnonStorey5C storeyc = new <OnFontChanged>c__AnonStorey5C {
                <>f__this = this
            };
            if (!this.invalidatingDependentControls)
            {
                storeyc.callback = null;
                storeyc.callback = new dfGUIManager.RenderCallback(storeyc.<>m__30);
                dfGUIManager.AfterRender += storeyc.callback;
            }
        }
        finally
        {
    ...
    [CompilerGenerated]
    private sealed class <OnFontChanged>c__AnonStorey5C
    {
        ...
        internal void <>m__30(dfGUIManager manager)
        {
            ...
            try
            {
                ...
                System.Collections.Generic.List<dfControl> list = UnityEngine.Object.FindObjectsOfType(typeof(dfControl)).Where<UnityEngine.Object>(<>f__am$cache2).Cast<dfControl>().OrderBy<dfControl, int>(<>f__am$cache3).ToList<dfControl>();
        ...
        private static bool <>m__31(UnityEngine.Object x)
        {
    ...
    public class DynamicFontRenderer : dfFontRendererBase
    {
        ...
        private System.Collections.Generic.List<dfMarkupToken> tokens;
        ...
        private System.Collections.Generic.List<dfMarkupToken> tokenize(string text)
        {
            try
            {
