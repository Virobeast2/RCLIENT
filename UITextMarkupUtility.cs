...
public static class UITextMarkupUtility
{
    ...
    public static string MarkUp(this System.Collections.Generic.List<UITextMarkup> list, string input)
    {
        int num;
    ...
    public static void SortMarkup(this System.Collections.Generic.List<UITextMarkup> list)
    {
