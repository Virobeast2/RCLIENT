...
public static class ReflectionExtensions
{
    ...
    public static FieldInfo[] GetAllFields(this System.Type type)
    {
        if (type == null)
        {
        ...
        return type.GetFields(bindingAttr).Concat<FieldInfo>(type.BaseType.GetAllFields()).Where<FieldInfo>(<>f__am$cache0).ToArray<FieldInfo>();
    }
