...
public class Character : IDMain
{
    ...
    [PrefetchChildComponent(NameMask="*Eyes"), SerializeField]
    private Transform _eyesTransform;
    [SerializeField, PrefetchChildComponent]
    ...
    public IDLocalCharacterAddon AddAddon(System.Type addonType)
    {
    ...
    public TBase AddAddon<TBase>(System.Type addonType) where TBase: IDLocalCharacterAddon
    {
    ...
    public IDLocalCharacterAddon AddAddon(string addonTypeName, System.Type minimumType)
    {
    ...
    public IDLocalCharacterAddon AddAddon(System.Type addonType, System.Type minimumType)
    {
    ...
    public bool CreateCCMotor()
    {
        ...
        CCTotemPole cc = (CCTotemPole) UnityEngine.Object.Instantiate(trait.prefab, this.origin, Quaternion.identity);
    ...
    public CharacterTrait GetTrait(System.Type characterTraitType)
    {
    ...
    private sealed class <>c__Iterator19 : IDisposable, IEnumerator, IEnumerable, IEnumerable<Character>, IEnumerator<Character>
    {
        ...
        internal int $PC;
        internal System.Collections.Generic.List<PlayerClient>.Enumerator <$s_182>__0;
    ...
    private sealed class <>c__Iterator1A : IDisposable, IEnumerator, IEnumerable, IEnumerable<Character>, IEnumerator<Character>
    {
        internal Character $current;
        internal int $PC;
        internal System.Collections.Generic.List<PlayerClient>.Enumerator <$s_183>__0;
        internal Controllable <controllable>__2;
        internal PlayerClient <pc>__1;
    ...
    {
        private static readonly Dictionary<System.Type, bool> validatedCache = new Dictionary<System.Type, bool>();

        public static bool Validate(System.Type type)
        {
            bool flag;
            if (type == null)
            {
    ...
    private static class AddonStringRegistry
    {
        ...
        private static bool Validate(string typeName, out System.Type type)
        {
            TypePair pair;
        ...
        public static bool Validate(string typeName, System.Type minimumType)
        {
            System.Type type;
            return (Validate(typeName, out type) && minimumType.IsAssignableFrom(type));
        }

        public static bool Validate<TBase>(string typeName, out System.Type type)
        {
            return (Validate(typeName, out type) && typeof(TBase).IsAssignableFrom(type));
        }
        ...
        private struct TypePair
        {
            ...
            public TypePair(System.Type type, bool valid)
            {
                this.type = type;
                this.valid = valid;
            }
