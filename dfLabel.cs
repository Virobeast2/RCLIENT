...
[Serializable, ExecuteInEditMode, RequireComponent(typeof(BoxCollider)), AddComponentMenu("Daikon Forge/User Interface/Label")]
public class dfLabel : dfControl, IDFMultiRender
{
    ...
    [SerializeField]
    protected System.Collections.Generic.List<int> tabStops = new System.Collections.Generic.List<int>();
    [SerializeField]
    ...
    public System.Collections.Generic.List<int> TabStops
    {
        get
        {
