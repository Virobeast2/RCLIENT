...
public class StructureMaster : IDMain, IServerSaveable, IServerSaveNotify
{
    ...
    protected System.Collections.Generic.List<Vector3> _foundationPoints;
    ...
    private static System.Collections.Generic.List<StructureMaster> g_Structures = new System.Collections.Generic.List<StructureMaster>();
    private static System.Collections.Generic.List<StructureMaster> g_StructuresWithBounds = new System.Collections.Generic.List<StructureMaster>();
    ...
    {
        System.Collections.Generic.List<StructureMaster> list = null;
        bool flag = false;
        System.Collections.Generic.List<KeyValuePair<StructureMaster, float>> list2 = new System.Collections.Generic.List<KeyValuePair<StructureMaster, float>>();
        foreach (StructureMaster master in AllStructuresWithBounds)
        {
            if (master == null)
            {
                ...
                {
                    flag = true;
                    list = new System.Collections.Generic.List<StructureMaster>();
                }
                list.Add(master);
            }
            else
    ...
    public static System.Collections.Generic.List<StructureMaster> AllStructures
    {
        get
        {
            return g_Structures;
    ...
    public static System.Collections.Generic.List<StructureMaster> AllStructuresWithBounds
    {
        get
        {
