...
public class RPOSWindowScrollable : RPOSWindow
{
    ...
    {
        return new <Routine_NextFrameRecalculateBounds>c__Iterator34 { <>f__this = this };
    }

    [CompilerGenerated]
    private sealed class <Routine_NextFrameRecalculateBounds>c__Iterator34 : IDisposable, IEnumerator, IEnumerator<object>
    {
