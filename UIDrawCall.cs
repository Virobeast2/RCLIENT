...
public class UIDrawCall : MonoBehaviour
{
    ...
    private UnityEngine.Mesh mMesh0;
    private UnityEngine.Mesh mMesh1;
    ...
    private UnityEngine.Mesh GetMesh(ref bool rebuildIndices, int vertexCount)
    {
        ...
        if (this.mEven)
        {
            if (this.mMesh0 == null)
            {
                this.mMesh0 = new UnityEngine.Mesh();
        ...
        if (this.mMesh1 == null)
        {
            this.mMesh1 = new UnityEngine.Mesh();
    ...
    public void Set(NGUI.Meshing.MeshBuffer m)
    {
        ...
        if (m.vSize < 0xfde8)
        {
            ...
            UnityEngine.Mesh mesh = this.GetMesh(ref rebuildIndices, m.vSize);
    ...
    public int triangles
    {
        get
        {
            UnityEngine.Mesh mesh = !this.mEven ? this.mMesh1 : this.mMesh0;
