...
public class CharacterRoamingTrait : CharacterTrait
{
    ...
    public float randomFleeDistance
    {
        get
        {
            return (!this._allowed ? 0f : ((this._minFleeDistance != this._maxFleeDistance) ? (this._minFleeDistance + ((this._maxFleeDistance - this._minFleeDistance) * UnityEngine.Random.value)) : this._minFleeDistance));
        }
    }
    ...
    public int randomIdleMilliseconds
    {
        get
        {
            return ((this._minIdleMilliseconds != this._maxIdleMilliseconds) ? ((this._minIdleMilliseconds >= this._maxIdleMilliseconds) ? UnityEngine.Random.Range(this._maxIdleMilliseconds, this._minIdleMilliseconds + 1) : UnityEngine.Random.Range(this._minIdleMilliseconds, this._maxIdleMilliseconds + 1)) : this._minIdleMilliseconds);
        }
    }
    ...
    public float randomRoamAngle
    {
        get
        {
            return (!this._allowed ? 0f : ((this._maxRoamAngle != this._minRoamAngle) ? (this._minRoamAngle + ((this._maxRoamAngle - this._minRoamAngle) * UnityEngine.Random.value)) : this._minRoamAngle));
        }
    }
    ...
    public float randomRoamDistance
    {
        get
        {
            return (!this._allowed ? 0f : ((this._minRoamDistance != this._maxRoamDistance) ? (this._minRoamDistance + ((this._maxRoamDistance - this._minRoamDistance) * UnityEngine.Random.value)) : this._minRoamDistance));
        }
    }
