...
{
    public static System.Collections.Generic.List<WoodBlockerTemp> _blockers;
    public float numWood;

    private void Awake()
    {
        TryInitBlockers();
        this.numWood = UnityEngine.Random.Range(10, 15);
        _blockers.Add(this);
    ...
    private static void TryInitBlockers()
    {
        if (_blockers == null)
        {
            _blockers = new System.Collections.Generic.List<WoodBlockerTemp>();
        }
    }
}
