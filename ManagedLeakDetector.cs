...
public class ManagedLeakDetector : MonoBehaviour
{
    ...
    private static bool CheckRelation(System.Type a, System.Type b)
    {
    ...
    {
        return Poll(typeof(UnityEngine.Object));
    }

    public static string Poll(System.Type searchType)
    {
        return Poll(searchType, typeof(UnityEngine.Object));
    }

    public static string Poll(System.Type searchType, System.Type minType)
    {
    ...
    private class ReadResult
    {
        ...
        public readonly System.Type minType;
        public readonly System.Type searchType;
        ...
        public ReadResult(System.Type searchType) : this(searchType, typeof(UnityEngine.Object))
        {
        }

        public unsafe ReadResult(System.Type searchType, System.Type minType)
        {
            System.Type expressionStack_19_0;
            ManagedLeakDetector.ReadResult expressionStack_19_1;
            ManagedLeakDetector.ReadResult expressionStack_E_1;
            System.Type expressionStack_31_0;
            ...
            else
            {
                ...
                System.Type expressionStack_E_0 = minType;
            }
            expressionStack_19_1 = expressionStack_E_1;
            expressionStack_19_0 = typeof(UnityEngine.Object);
        Label_0019:
            ...
            else
            {
                ...
                System.Type expressionStack_26_0 = searchType;
            }
            expressionStack_31_1 = expressionStack_26_1;
            expressionStack_31_0 = typeof(UnityEngine.Object);
        Label_0031:
        ...
        Label_027E:
            ...
            this.sumMesh.check = ManagedLeakDetector.CheckRelation(typeof(UnityEngine.Mesh), searchType);
        ...
        public void Read(bool forceUpdate)
        {
            ...
            {
                Dictionary<System.Type, ManagedLeakDetector.Counter> dictionary = new Dictionary<System.Type, ManagedLeakDetector.Counter>();
                ...
                this.sumMesh.check = ManagedLeakDetector.CheckRelation(typeof(UnityEngine.Mesh), this.searchType);
                ...
                foreach (UnityEngine.Object obj2 in UnityEngine.Object.FindObjectsOfType(this.searchType))
                {
                    ...
                    else if (this.sumMesh.check && typeof(UnityEngine.Mesh).IsAssignableFrom(key))
                    {
                        this.sumMesh.total++;
                    }
                    ...
                    if (key != this.minType)
                    {
                        for (key = key.BaseType; key != typeof(UnityEngine.Object); key = key.BaseType)
                        {
                            if (dictionary.TryGetValue(key, out counter2))
                            {
                ...
                System.Collections.Generic.List<ManagedLeakDetector.Counter> list = new System.Collections.Generic.List<ManagedLeakDetector.Counter>(dictionary.Values);
