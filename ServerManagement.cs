...
{
    [NonSerialized]
    protected readonly System.Collections.Generic.List<PlayerClient> _playerClientList;
    ...
    public ServerManagement() : this(new System.Collections.Generic.List<PlayerClient>())
    {
    }

    private ServerManagement(System.Collections.Generic.List<PlayerClient> pcList)
    {
    ...
    private sealed class <FindPlayerClientsByName>c__Iterator2D : IDisposable, IEnumerator, IEnumerable, IEnumerable<PlayerClient>, IEnumerator<PlayerClient>
    {
        ...
        internal System.Collections.Generic.List<PlayerClient>.Enumerator <$s_295>__0;
    ...
    private sealed class <FindPlayerClientsByString>c__Iterator2C : IDisposable, IEnumerator, IEnumerable, IEnumerable<PlayerClient>, IEnumerator<PlayerClient>
    {
        ...
        internal int $PC;
        internal string <$>name;
        internal System.Collections.Generic.List<PlayerClient>.Enumerator <$s_292>__2;
        internal System.Collections.Generic.List<PlayerClient>.Enumerator <$s_293>__4;
        internal System.Collections.Generic.List<PlayerClient>.Enumerator <$s_294>__6;
        internal ServerManagement <>f__this;
    ...
    [CompilerGenerated]
    private sealed class <GetNetworkPlayersByName>c__Iterator2E : IDisposable, IEnumerator, IEnumerable, IEnumerable<uLink.NetworkPlayer>, IEnumerator<uLink.NetworkPlayer>
    {
        ...
        [DebuggerHidden]
        IEnumerator<uLink.NetworkPlayer> IEnumerable<uLink.NetworkPlayer>.GetEnumerator()
        {
            if (Interlocked.CompareExchange(ref this.$PC, 0, -2) == -2)
            {
                return this;
        ...
        uLink.NetworkPlayer IEnumerator<uLink.NetworkPlayer>.Current
        {
            [DebuggerHidden]
            get
            {
    ...
    [CompilerGenerated]
    private sealed class <GetNetworkPlayersByString>c__Iterator2F : IDisposable, IEnumerator, IEnumerable, IEnumerable<uLink.NetworkPlayer>, IEnumerator<uLink.NetworkPlayer>
    {
        internal uLink.NetworkPlayer $current;
        internal int $PC;
