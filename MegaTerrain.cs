...
public class MegaTerrain : MonoBehaviour
{
    ...
    public UnityEngine.Terrain[] _terrains;
    public string name_base = "rust_terrain";

    public UnityEngine.Terrain FindTerrain(int x, int y)
    {
        object[] objArray1 = new object[] { this.name_base, "_x", x, "_y", y };
        string name = string.Concat(objArray1);
        return ((GameObject.Find(name) == null) ? null : GameObject.Find(name).GetComponent<UnityEngine.Terrain>());
    }
