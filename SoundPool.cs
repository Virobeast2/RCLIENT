...
public static class SoundPool
{
    ...
    private static readonly System.Type[] goTypes = new System.Type[] { typeof(AudioSource) };
    ...
    private static UnityEngine.Object TARG(ref Settings settings)
    {
        return ((settings.parent == null) ? ((UnityEngine.Object) settings.clip) : ((UnityEngine.Object) settings.parent));
    }
    ...
    private static class NodeGC
    {
        ...
        private static class GCDAT
        {
            ...
            public static readonly System.Collections.Generic.List<Transform> destroyTheseNextPump = new System.Collections.Generic.List<Transform>();
