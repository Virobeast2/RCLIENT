...
public class dfTouchEventArgs : dfMouseEventArgs
{
    ...
    {
        this.Touch = touch;
        this.Touches = new System.Collections.Generic.List<UnityEngine.Touch> { touch };
    ...
    public System.Collections.Generic.List<UnityEngine.Touch> Touches { get; private set; }
}
