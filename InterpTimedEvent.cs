...
public sealed class InterpTimedEvent : IDisposable
{
    ...
    {
        System.Type c = current.args.types[index];
    ...
    public static bool ArgumentIs(int index, System.Type comptype)
    {
        System.Type type = current.args.types[index];
        return (comptype.IsAssignableFrom(current.args.types[index]) || ((type == typeof(void)) && !comptype.IsValueType));
    }

    public static System.Type ArgumentType(int index)
    {
    ...
    public static System.Type[] ArgumentTypeArray
    {
        get
        {
    ...
    public sealed class ArgList : IDisposable
    {
        ...
        private ArgList(int length)
        {
            ...
            this.types = new System.Type[length];
        }
    ...
    internal struct LList
    {
        ...
        public System.Collections.Generic.List<InterpTimedEvent> EmergencyDump(bool botherSorting)
        {
            bool flag;
            ...
            System.Collections.Generic.List<InterpTimedEvent> list = new System.Collections.Generic.List<InterpTimedEvent>(collection);
            if (botherSorting)
            {
                try
                {
