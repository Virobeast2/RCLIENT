...
public abstract class AuthorCreation : AuthorShared
{
    ...
    [SerializeField]
    private System.Collections.Generic.List<AuthorPeice> allPeices;
    ...
    [NonSerialized]
    public readonly System.Type outputType;
    protected int palletLabelHeight;
    protected int palletPanelWidth;
    [NonSerialized]
    private System.Collections.Generic.List<AuthorPeice> selected;
    ...
    protected AuthorCreation(System.Type outputType) : this()
    {
    ...
    public TPeice CreatePeice<TPeice>(string id, params System.Type[] additionalComponents) where TPeice: AuthorPeice
    {
        System.Type[] destinationArray = new System.Type[additionalComponents.Length + 1];
    ...
    [DebuggerHidden]
    private IEnumerable<AuthorPeice> DoGUIPeiceInspector(System.Collections.Generic.List<AuthorPeice> peices)
    {
        return new <DoGUIPeiceInspector>c__Iterator3 { peices = peices, <$>peices = peices, $PC = -2 };
    }

    [DebuggerHidden]
    private IEnumerable<AuthorShared.PeiceCommand> DoGUIPeiceList(System.Collections.Generic.List<AuthorPeice> peices)
    {
    ...
    {
        return (((this.allPeices != null) && (this.allPeices.Count != 0)) ? ((IEnumerable<AuthorPeice>) new System.Collections.Generic.List<AuthorPeice>(this.allPeices)) : ((IEnumerable<AuthorPeice>) NoPeices));
    }
    ...
    {
        return (((this.selected != null) && (this.selected.Count != 0)) ? ((IEnumerable<AuthorPeice>) new System.Collections.Generic.List<AuthorPeice>(this.selected)) : ((IEnumerable<AuthorPeice>) NoPeices));
    }
    ...
    public virtual void ExecuteCommand(AuthorShared.PeiceCommand cmd)
    {
        ...
        switch (cmd.action)
        {
            ...
            {
                UnityEngine.Object selectReference = cmd.peice.selectReference;
                UnityEngine.Object[] allSelectedObjects = AuthorShared.GetAllSelectedObjects();
                Array.Resize<UnityEngine.Object>(ref allSelectedObjects, allSelectedObjects.Length + 1);
            ...
            {
                UnityEngine.Object obj3 = cmd.peice.selectReference;
                UnityEngine.Object[] array = AuthorShared.GetAllSelectedObjects();
                int newSize = 0;
                ...
                {
                    Array.Resize<UnityEngine.Object>(ref array, newSize);
            ...
            {
                UnityEngine.Object[] objects = new UnityEngine.Object[] { cmd.peice.selectReference };
        ...
        try
        {
            while (enumerator.MoveNext())
            {
                ...
                if (GUILayout.Button(current.guiContent, buttonStyle, options) && current.Create(this, out peice))
                {
                    ...
                    {
                        UnityEngine.Object.DestroyImmediate(peice.gameObject);
                    }
                    else
                    {
                        flag2 = true;
    ...
    protected virtual bool RegisterPeice(AuthorPeice peice)
    {
        if (this.allPeices == null)
        {
            this.allPeices = new System.Collections.Generic.List<AuthorPeice>();
    ...
    {
        System.Collections.Generic.List<AuthorPeice> collection = null;
        foreach (UnityEngine.Object obj2 in objects)
        {
            if ((obj2 is AuthorPeice) && (obj2 != null))
            {
                if (collection == null)
                {
                    collection = new System.Collections.Generic.List<AuthorPeice> {
                        (AuthorPeice) obj2
                    };
                }
        ...
        try
        {
            ...
            if (this.allPeices != null)
            {
                collection.Sort((x, y) => this.allPeices.IndexOf(x).CompareTo(this.allPeices.IndexOf(y)));
            }
            if ((this.selected == null) || (this.selected.Count != collection.Count))
            {
                return true;
            }
            using (System.Collections.Generic.List<AuthorPeice>.Enumerator enumerator = this.selected.GetEnumerator())
            {
                using (System.Collections.Generic.List<AuthorPeice>.Enumerator enumerator2 = collection.GetEnumerator())
                {
    ...
    private sealed class <DoGUIPeiceInspector>c__Iterator3 : IDisposable, IEnumerable<AuthorPeice>, IEnumerator<AuthorPeice>, IEnumerator, IEnumerable
    {
        ...
        internal int $PC;
        internal System.Collections.Generic.List<AuthorPeice> <$>peices;
        internal System.Collections.Generic.List<AuthorPeice>.Enumerator <$s_20>__0;
        internal bool <b>__2;
    ...
    private sealed class <DoGUIPeiceList>c__Iterator4 : IDisposable, IEnumerator, IEnumerable, IEnumerable<AuthorShared.PeiceCommand>, IEnumerator<AuthorShared.PeiceCommand>
    {
        ...
        internal int $PC;
        internal System.Collections.Generic.List<AuthorPeice> <$>peices;
        internal System.Collections.Generic.List<AuthorPeice>.Enumerator <$s_21>__0;
    ...
    private sealed class <DoSceneView>c__Iterator5 : IDisposable, IEnumerable<AuthorPeice>, IEnumerator<AuthorPeice>, IEnumerator, IEnumerable
    {
        internal AuthorPeice $current;
        internal int $PC;
        internal System.Collections.Generic.List<AuthorPeice>.Enumerator <$s_22>__3;
