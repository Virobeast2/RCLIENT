...
public class ConsoleSystem
{
    ...
    public static string CollectSavedFields(System.Type type)
    {
    ...
    public static string CollectSavedFunctions(System.Type type)
    {
        string str = string.Empty;
    ...
    public static string CollectSavedProperties(System.Type type)
    {
        string str = string.Empty;
    ...
    public static System.Type[] FindTypes(string className)
    {
        System.Collections.Generic.List<System.Type> list = new System.Collections.Generic.List<System.Type>();
        Assembly[] assemblies = AppDomain.CurrentDomain.GetAssemblies();
        for (int i = 0; i < assemblies.Length; i++)
        {
            System.Type item = assemblies[i].GetType(className);
            ...
            if ((field != null) && field.IsStatic)
            {
                ...
                if (arg.HasArgs(1))
                {
                    try
                    {
                        ...
                        if (bWantReply)
                        {
                            arg.ReplyWith(arg.Class + "." + arg.Function + ": changed " + Facepunch.Utility.String.QuoteSafe(str) + " to " + Facepunch.Utility.String.QuoteSafe(field.GetValue(null).ToString()) + " (" + fieldType.Name + ")");
                        }
                    }
                    catch (Exception)
                    {
                ...
                {
                    arg.ReplyWith(arg.Class + "." + arg.Function + ": " + Facepunch.Utility.String.QuoteSafe(field.GetValue(null).ToString()) + " (" + fieldType.Name + ")");
                }
                return true;
            }
            ...
            if (((property != null) && property.GetGetMethod().IsStatic) && property.GetSetMethod().IsStatic)
            {
                ...
                if (arg.HasArgs(1))
                {
                    try
                    {
                        ...
                        if (bWantReply)
                        {
                            arg.ReplyWith(arg.Class + "." + arg.Function + ": changed " + Facepunch.Utility.String.QuoteSafe(str2) + " to " + Facepunch.Utility.String.QuoteSafe(property.GetValue(null, null).ToString()) + " (" + propertyType.Name + ")");
                        }
                    }
                    catch (Exception)
                    {
                ...
                {
                    arg.ReplyWith(arg.Class + "." + arg.Function + ": " + Facepunch.Utility.String.QuoteSafe(property.GetValue(null, null).ToString()) + " (" + propertyType.Name + ")");
                }
                return true;
            }
        }
    ...
    public class Arg
    {
        ...
        public Enum GetEnum(System.Type enumType, int iArg, Enum def)
        {
    ...
    public static class Parse
    {
        ...
        public static bool AttemptEnum(System.Type enumType, string text, out System.Enum value)
        {
            bool flag;
            try
            {
        ...
        public static bool AttemptObject(System.Type type, string value, out object boxed)
        {
            try
            {
        ...
        public static System.Enum DefaultEnum(System.Type enumType, string text)
        {
            return DefaultEnum(enumType, text, 0);
        }

        public static System.Enum DefaultEnum(System.Type enumType, string text, System.Enum @default)
        {
            System.Enum enum2;
        ...
        public static System.Enum Enum(System.Type enumType, string text)
        {
            System.Enum enum2;
            try
            {
