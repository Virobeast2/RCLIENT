...
{
    private System.Type _minimumType = typeof(MonoBehaviour);
    public readonly System.Type Interface;
    ...
    public InterfaceDriverComponentAttribute(System.Type interfaceType, string serializedFieldName, string runtimeFieldName)
    {
    ...
    public System.Type UnityType
    {
        ...
        set
        {
            System.Type expressionStack_13_0;
            ...
            else
            {
                ...
                System.Type expressionStack_8_0 = value;
            }
